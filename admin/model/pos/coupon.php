<?php
class ModelPosCoupon extends Model {
...
$this->load->model('sale/order');
		...
		foreach ($this->cart->getProducts($this->request->get['order_idx']) as $x) {
					$product_det = $this->model_sale_order->getOrderProduct($this->request->get['order_idx'],$x['product_id']);
				
				$xprice =   ($product_det['price']*$x['quantity']);
				$sub_total+=$xprice;
		}
