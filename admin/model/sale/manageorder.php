...
class ModelSaleManageOrder extends Model {	
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.ref_order_id,o.admin_view_only,o.order_id, CONCAT(o.invoice_prefix,o.invoice_no) AS invoice_id, CONCAT(o.shipping_firstname, ' ', o.shipping_lastname , '<br />' , o.shipping_address_1 , ' ' , o.shipping_address_2, ' ', o.shipping_city, ' ', o.shipping_zone, ' ', o.shipping_postcode , '<br />', o.shipping_country, '<br />', o.telephone) AS customer, o.email, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS status, o.payment_method, (SELECT ot.value FROM " . DB_PREFIX . "order_total ot WHERE ot.order_id = o.order_id AND ot.code = 'sub_total') AS sub_total, (SELECT ot.value FROM " . DB_PREFIX . "order_total ot WHERE ot.order_id = o.order_id AND ot.code = 'credit') AS store_credit, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified,o.cash_split,o.card_split FROM `" . DB_PREFIX . "order` o";
		...
		if (isset($data['filter_customer']) && !is_null($data['filter_customer'])) {
			$sql .= " AND CONCAT(LCASE(o.shipping_firstname), ' ', LCASE(o.shipping_lastname) , '<br />' , LCASE(o.shipping_address_1) , ' ' , LCASE(o.shipping_address_2), ' ', LCASE(o.shipping_city), ' ', LCASE(o.shipping_zone), ' ', LCASE(o.shipping_postcode) , '<br />', LCASE(o.shipping_country), '<br />', o.telephone) LIKE '%" . $this->db->escape(strtolower($data['filter_customer'])) . "%'";
		}

		if (isset($data['filter_email']) && !is_null($data['filter_email'])) {
			$sql .= " AND LCASE(o.email) LIKE '%" . $this->db->escape(strtolower($data['filter_email'])) . "%'";
		}
