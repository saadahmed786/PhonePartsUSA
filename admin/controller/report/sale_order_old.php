...
class ControllerReportSaleOrder extends Controller { 
	public function index() {  
		...
		$this->data['export_link'] = $this->url->link('report/sale_order/export','token=' . $this->session->data['token']. $url . '&page={page}', 'SSL');
		### export to csv ###
	...
	public function export(){
		$this->load->language('report/sale_order');
		$titlearr = array($this->language->get('column_date_start'),$this->language->get('column_date_end'),$this->language->get('column_orders'),$this->language->get('column_total'));
		...
		foreach ($results as $result) {
			$out .='"'.date($this->language->get('date_format_short'), strtotime($result['date_start'])).'",';
			$out .='"'.date($this->language->get('date_format_short'), strtotime($result['date_end'])).'",';
			$out .='"'.$result['orders'].'",';
			$out .='"'. utf8_decode($this->currency->format($result['total'], $this->config->get('config_currency'))).'",';
			$out .="\n";
		}
