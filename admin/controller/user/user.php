...
class ControllerUserUser extends Controller {  
	...
	private function getForm() {
		...
		if (isset($this->request->post['view_returned_items'])) {
      		$this->data['view_returned_items'] = $this->request->post['view_returned_items'];
    	} elseif (!empty($user_info)) {
			$this->data['view_returned_items'] = $user_info['view_returned_items'];
		} else {
      		$this->data['view_returned_items'] = '';
    	}
		
		if (isset($this->request->post['can_edit_order'])) {
      		$this->data['can_edit_order'] = $this->request->post['can_edit_order'];
    	} elseif (!empty($user_info)) {
			$this->data['can_edit_order'] = $user_info['can_edit_order'];
		} else {
      		$this->data['can_edit_order'] = '';
    	}

    	if (isset($this->request->post['can_create_order'])) {
      		$this->data['can_create_order'] = $this->request->post['can_create_order'];
    	} elseif (!empty($user_info)) {
			$this->data['can_create_order'] = $user_info['can_create_order'];
		} else {
      		$this->data['can_create_order'] = '';
    	}

    	if (isset($this->request->post['can_process_rma'])) {
      		$this->data['can_process_rma'] = $this->request->post['can_process_rma'];
    	} elseif (!empty($user_info)) {
			$this->data['can_process_rma'] = $user_info['can_process_rma'];
		} else {
      		$this->data['can_process_rma'] = '';
    	}

    	if (isset($this->request->post['can_issue_store_credit'])) {
      		$this->data['can_issue_store_credit'] = $this->request->post['can_issue_store_credit'];
    	} elseif (!empty($user_info)) {
			$this->data['can_issue_store_credit'] = $user_info['can_issue_store_credit'];
		} else {
      		$this->data['can_issue_store_credit'] = '';
    	}



    	if (isset($this->request->post['update_b_order'])) {
      		$this->data['update_b_order'] = $this->request->post['update_b_order'];
    	} elseif (!empty($user_info)) {
			$this->data['update_b_order'] = $user_info['update_b_order'];
		} else {
      		$this->data['update_b_order'] = '';
    	}
		
		if (isset($this->request->post['pos_user'])) {
      		$this->data['pos_user'] = $this->request->post['pos_user'];
    	} elseif (!empty($user_info)) {
			$this->data['pos_user'] = $user_info['pos_user'];
		} else {
      		$this->data['pos_user'] = '';
    	}
