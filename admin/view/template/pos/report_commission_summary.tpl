    ...
    <div class="content">
      ...
      <table class="list">
        ...
        <tbody>
          ...
          <tr>
		    <td class="left"><?php echo $commission['username']; ?></td>
            <td class="left"><?php echo $commission['date_start']; ?></td>
            <td class="left"><?php echo $commission['date_end']; ?></td>
