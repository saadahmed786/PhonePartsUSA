...
<head>
	...
	<script src="../admin/elfinder/jquery/jquery-1.7.2.min.js" type="text/javascript" charset="utf-8"></script>
...
*/		
	...
	<script type="text/javascript" charset="utf-8">
     $().ready(function() {
         ...
         if(valueField == "filemanager") {
             $('#finder').elfinder({
                 url: '../admin/elfinder/php/connector.php?field=filemanager',
                 lang: 'en',
                 resizable: 'false',
                 commands: [
