...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
        ...
        <div class="dashboard-content">
          <table class="list">
            ...
            <tbody>
              ...
              {
              ?>
                <td class="right"><?php echo $order['ref_order_id']; ?></td>
                <?php
                }
                else
                {
      ...
      <br>
      <div>
      <iframe src="index.php?route=pos/dashboard&token=<?php echo $token; ?>&embed=1" style="width:100%;border:1px solid #8eaec3;height:700px"></iframe>
      </div>
    </div>
  </div>
</div>
