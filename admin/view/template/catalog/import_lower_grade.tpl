...
<?php if ($success) { ?>
  ...
  <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button">Import</a> <a onclick="window.location='index.php?route=catalog/product/export_lower_grade&token=<?php echo $token;?>'" class="button">Export</a> <a onclick="location = '<?php echo $cancel; ?>';" class="button">Cancel</a></div>

    </div>

    <div class="content">

      <div id="tabs" class="htabs"><a href="#tab-general">Import CSV</a></div>
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="file" name="csv" value="" />
               ...
               <small>  (<a href="csv_templates/2.csv">Click here</a> to download the CSV Template)</small>
                </td>
