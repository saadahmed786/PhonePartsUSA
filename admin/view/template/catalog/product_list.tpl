...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="location = '<?php echo $insert; ?>'" class="button"><?php echo $button_insert; ?></a> <a onclick="location = '<?php echo $export_out_of_stock;?>'" target="_blank" class="button">Export OOS CSV</a><a onclick="$('#form').attr('action', '<?php echo $copy; ?>'); $('#form').submit();" class="button"><?php echo $button_copy; ?></a><a onclick="$('form').submit();" class="button"><?php echo $button_delete; ?></a> <a onclick="location = '<?php echo $export_sub_images;?>'" target="_blank" class="button">Export Sub Images CSV</a>  <a onclick="location = '<?php echo $import_sub_images;?>'" target="_blank" class="button">Import Sub Images CSV</a></div>
    </div>
    <div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
			...
			echo '<a title="Click to Expand / Collapse" data-condition="0" onClick="$(\'#slide'.$product['product_id'].'\').slideToggle();if($(this).attr(\'data-condition\')==0){$(this).attr(\'data-condition\',1); $(\'#plus'.$product['product_id'].'\').html(\'-\')}else{$(this).attr(\'data-condition\',0); $(\'#plus'.$product['product_id'].'\').html(\'+\')}"><span  id=\'plus'.$product['product_id'].'\'>+</span> Total '.count($product['category']).' Categories</a>';
            echo "<div id='slide".$product['product_id']."' style='display:none'>";
