...
<?php if ($success) { ?>
  ...
  <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons"><a onclick="$('#form').submit();" class="button">Import</a>  <a onclick="location = '<?php echo $cancel; ?>';" class="button">Cancel</a></div>
        ...
        <div id="tab-general">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <small>  (<a href="csv_templates/1.csv">Click here</a> to download the CSV Template)</small>
                </td>
