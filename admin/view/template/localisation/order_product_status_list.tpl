      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($order_product_status['selected']) { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php echo $order_product_status['name']; ?></td>
              <td class="right"><?php foreach ($order_product_status['action'] as $action) { ?>
