    ...
    <div id="tab_general" class="page">
      <table class="form">
        <tr>
          ...
          <td><select name="<?php echo $classname; ?>_status">
            <?php if (${$classname."_status"}) { ?>
        ...
        <tr>
          <td><?php echo $entry_module_position; ?></td>
          <td><select name="<?php echo $classname; ?>_position">
            <?php if (${$classname."_position"} == 'left') { ?>
        ...
        <tr>
          ...
          <td><input type="text" name="<?php echo $classname; ?>_sort_order" value="<?php echo ${$classname."_sort_order"}; ?>" size="1" /></td>
        </tr>
      </table>
    </div>
  </form>
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table id="module" class="list">
        <thead>
          <tr>
		    <td class="left"><?php echo $entry_wrapper; ?></td>
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
			<td class="left"><select name="<?php echo $classname; ?>_module[<?php echo $module_row; ?>][wrapper]">
                <?php if ($module['wrapper']) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                <option value="0"><?php echo $text_disabled; ?></option>
                <?php } else { ?>
                <option value="1"><?php echo $text_enabled; ?></option>
                <option value="0" selected="selected"><?php echo $text_disabled; ?></option>
                <?php } ?>
              </select><br /><span class="help"><?php echo $help_wrapper; ?></span></td>
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="<?php echo $classname; ?>_module[' + module_row + '][wrapper]">';
