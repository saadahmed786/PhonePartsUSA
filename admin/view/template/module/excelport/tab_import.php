<table class="form">
    <tr>
        <td>
            ...
            <div class="question"><input id="checkboxDelete" type="checkbox" name="ExcelPort[Import][Delete]" value="1" /><label for="checkboxDelete"><?php echo $text_question_delete_other; ?></label></div>
            <div class="question" data-depends-on="#DataTypeProductsOptionImport"><input id="checkboxAddAsNew" type="checkbox" name="ExcelPort[Import][AddAsNew]" value="1" <?php echo !empty($data['ExcelPort']['Import']['AddAsNew']) ? 'checked="checked"' : ''; ?> /><label for="checkboxAddAsNew"><?php echo $text_question_add_as_new; ?></label></div>
        </td>  
    </tr>
    <tr>
        <td>
