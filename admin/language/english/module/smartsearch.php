...
$_['entry_product_fields_searched']	= 'Product Fields Searched:<br /><br /><span class="help">Product names are always searched.<br /><br />Selecting "Description (Phases 3 & 4)" can slow down search results if you have a lot of products.<br /><br />Attribute fields are only available in OpenCart 1.5.x versions.</span>';
