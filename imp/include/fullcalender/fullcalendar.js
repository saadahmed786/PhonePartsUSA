...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		titleHtml =
			'<span id="' + event.eventId + '" class="fc-title" data-sdate="' + event.start.format('YYYY-MM-DD') + '">' +
			...
			'>' +
				'<div class="fc-content">' +
					...
					(event.title ?
						...
						'</div><span class="fc-edit" data-id="'+ event.eventId +'">Edit</span><span class="fc-delete" data-id="'+ event.eventId +'" data-did="'+ event._id +'">Delete</span>' :
						''
						) +
					(event.description ?
						'<div class="fc-title">' +
