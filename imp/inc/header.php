...
?>
<?php
if($_SESSION['group']!='Admin' && $_SESSION['group']!='Programmer' && $_SESSION['group']!='Super Admin' )
{
  $_SESSION['login_as'] = 'employee';
}
?>
<style>
    <?php if ($script_name != 'man_catalog.php' && $script_name!='server_emails_new.php') { ;?>
        * { font-family: Verdana, Geneva, sans-serif; font-size:11px; }
        ...
        .blackPage {position: fixed; background: rgba(0,0,0,.5); height: 100%; width: 100%; top: 0; left: 0; z-index: 3;}
    ...
    <?php
if ($script_name != 'return_detail.php') {
    ?>
        ...
        <?php if (@$_SESSION['error']): ?>
            ...
            <tr>
                    ...
                    <div> 
                            ...
                            <li>
                                ...
                                <ul class="drop">
                                    ...
                                    <?php if ($_SESSION['login_as'] == 'admin'): ?>
                                        ...
                                        <li><a href="<?php echo $host_path ?>newsfeed.php">News Feed</a></li>
                        ...
                        ?>
                            ...
                            <?php if ($_SESSION['login_as'] == 'admin'): ?>
                                ...
                                <li>
                                    ...
                                    <ul class="drop">
                                       ...
                                       <?php
                                        ...
                                        <li><a href="<?php echo $host_path ?>chart_of_accounts.php">Chart of Accounts</a></li>
                                        <li><a href="<?php echo $host_path ?>balance_sheet.php">Balance Sheet</a></li>
                                ...
                                <li><a href="<?php echo $host_path ?>shipping_management.php">Shipping Management</a></li>
                            <?php endif; ?>

                            <?php if ($_SESSION['credit_management_report'] || $_SESSION['login_as']=='admin') : ?>
                                <li><a href="<?php echo $host_path ?>credit_management_new.php">Payment Management</a></li>
                            <?php endif; ?>
                         ...
                         <?php
                            ...
                            <li>
                                ...
                                <?php if ($_SESSION['order_history']): ?>
                                    ...
                                    <li><a href="<?php echo $host_path ?>inventory">Order Scanning</a></li>
                                <?php endif;?>
                ...
                ?>
                    ...
                    <?php if ($_SESSION['po_business'] && $_SESSION['group']!='Vendor'): ?>
                        ...
                        <li>
                            ...
                            <ul class="drop">
                                ...
                                <?php if ($_SESSION['wholesale']): ?>
                                    ...
                                    <li><a href="<?php echo $host_path ?>wholesale_create.php">Create Account</a></li>
                                ...
                                <?php if ($_SESSION['wholesale']): ?>
                                    ...
                                    <li><a href="<?php echo $host_path ?>wholesale.php">Business Application</a></li>
                    ...
                    <?php endif ?>
    <!--Commented on requirement by gohar 11-15-2017-->
                   <!-- <li>
                    ...
                    <li>
                        ...
                        <ul class="drop">
                            ...
                            <!-- <li><a href="<?php echo $host_path ?>products_beta.php">Products (BETA)</a></li> -->
                            <li><a href="<?php echo $host_path ?>restock_requests.php">Restock Requests</a></li>
                            ...
                            <?php if ($_SESSION['create_order']): ?>
                                ...
                                <li><a href="<?php echo $host_path ?>daily_total_inventory_cost.php">Inventory Cost Report</a></li>

                                <li> <a href="<?php echo $host_path ?>vendor_finance_report.php">Vendor Finance Report</a></li>
                            ...
                            <li><a href="<?php echo $host_path;?>scrapper.php">Competitor Pricing</a></li>
                            <li><a href="<?php echo $host_path;?>competitor_module_new.php">Competitor Pricing</a></li>

                            <?php endif;?>
                             <?php if($_SESSION['competitor_dashboard']):?>
                            <li><a href="<?php echo $host_path ?>competitor_dashboard.php">Competitor Dashboard</a></li>
                        <?php endif; ?>
                ...
                ?>
                    ...
                    <?php if ($_SESSION['manage_returns'] && $_SESSION['group']!='Vendor'): ?>
                        ...
                        <li>
                            ...
                            <ul class="drop">
                                ...
                                <li><a href="<?php echo $host_path ?>return_create.php">Create RMA (Multiple Orders)</a></li>
                                <li><a href="<?php echo $host_path ?>returns.php">Create RMA (Single Order)</a></li>
                                ...
                                <?php if ($_SESSION['returns_boxes']): ?>
                                    ...
                                    <li><a href="<?php echo $host_path ?>boxes/return_to_stock.php">Good For Stock Boxes</a></li>
                                ...
                                <li><a href="<?php echo $host_path ?>return_rj_search.php">Daily Return & RTV</a></li>
                    ...
                    <?php endif; ?> 
                        ...
                        <li><a href="">Purchasing</a>
                            <ul class="drop">
                            <?php if ($_SESSION['purchasing']): ?>
                            <li><a href="<?php echo $host_path ?>sales.php">Create PO</a></li>
                            ...
                            <?php
                                ...
                                {
                                    ?>
                                <li><a href="<?php echo $host_path ?>vendor_credit.php">Vendor Credit</a></li>
                                <?php
                            }
                            ?>
                    ...
                    <li>
                        ...
                        <ul class="drop">
                            ...
                            <?php if ($_SESSION['rejected_shipment']): ?>
                                ...
                                <li><a href="<?php echo $host_path ?>rejected_shipments.php">Return to Vendor</a></li>
                   ...
                   <!-- Commented on requirement by gohar 11-15-2017-->
                    <!-- <li>
                            ...
                            <a href="#">Refurbishing</a>

                            <ul class="drop">

                                <li><a href="<?php echo $host_path ?>refurbishing/refurb_inputs.php">Refurb Inputs</a></li>
                                <li><a href="<?php echo $host_path ?>refurbishing/refurb_shipments.php">Refurb Shipments</a></li>
                                <li><a href="<?php echo $host_path ?>refurbishing/refurb_box_shipments.php">Refurb Boxes</a></li>
                     ...
                     <li>
                        ...
                        <ul class="drop">
                            ...
                            <?php if($_SESSION['sales_dashboard']) : ?>
                                <li><a href="<?php echo $host_path ?>sales_dashboard_new.php">Sales Dashboard v1</a></li>
                                <li><a href="<?php echo $host_path ?>sales_dashboard_v2.php">Sales Dashboard v2</a></li>
                            <?php endif; ?>
                            <li><a href="<?php echo $host_path ?>agent_dashboard.php">Agent Dashboard</a></li>
                            <li><a href="<?php echo $host_path ?>daily_sale_report.php">Daily Sales Report</a></li>
                            <li><a href="<?php echo $host_path ?>one_shipment_report.php">One Shipment Report</a></li>
                            <li><a href="<?php echo $host_path ?>transaction_report.php">Transaction Report</a></li>
                            <li><a href="<?php echo $host_path ?>cancelled_orders_report.php">Cancelled Orders</a></li>
                            <?php if($_SESSION['login_as'] == 'admin') { ?>
                                <li><a href="<?php echo $host_path ?>emailing_lists.php">Reports Emailing Lists</a></li>
                                <li><a href="<?php echo $host_path ?>scaling_up.php">Scaling Up Metrics</a></li>
                                <li><a href="<?php echo $host_path ?>warehouse_vouchers_report.php">Warehouse Vouchers Report</a></li>
                                <li><a href="<?php echo $host_path ?>sales_related_report.php">Sales Related Report</a></li>
                                <li><a href="<?php echo $host_path ?>operational_manager_report.php">Operation Manager Report</a></li>
                            <?php } ?>
                            <?php
                            if($_SESSION['conversion_report'])
                            {
                                ?>

                            <li><a href="<?php echo $host_path ?>conversion_report.php">Conversion Report</a></li>
                                <?php
                            }
                            ...
                            <li><a href="<?php echo $host_path ?>inventory_movement_report.php">Inventory Movement Report</a></li>
                                <?php
                            }
                            ?>

                            <?php
                            if($_SESSION['purchasing_metrics'])
                            {
                                ?>

                            <li><a href="<?php echo $host_path ?>purchasing_metrics.php">Purchasing Metrics</a></li>
                                <?php
                            }
                            ?>
                        </ul>
                ...
                ?>
                    ...
                    <?php if ($_SESSION['login_as'] == 'admin'): ?> 
                        ...
                        <li>
                            ...
                            <ul class="drop">
                                ...
                                <li><a href="<?php echo $host_path ?>print_sku_list.php">Printing SKU List</a></li>
                    ...
                    <li>
                        ...
                        <ul class="drop">
                            ...
                            <li><a href="<?php echo $host_path ?>oc_notification.php">OC Notifications</a></li>
                            <li><a href="<?php echo $host_path ?>inventory_setting.php">Inventory Setting</a></li>
                            ...
                            ?>
                            <li><a href="<?php echo $host_path ?>remove_cache.php">Remove Cache</a></li>
