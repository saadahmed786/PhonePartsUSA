...
<html>
    ...
    <body>
        ...
        <?php if($shipments):?>
          ...
          <div align="center"><input type="button" value="Make Payment" onclick="make_payment(this);"> <input type="button" value="Add Line Item" onclick="add_line_item(this);"> </div><br>
...
$balance = round($balance,2) - round($shipment['total'],2);
                   ...
                   ?>
                       ...
                       <tr id="<?php echo $shipment['id'];?>" >
                          ...
                          if($is_voucher==false):
                          ?>
                          <td align="center">$<?php echo number_format(($shipment['extra']['received_total'] / $shipment['ex_rate']) + ($shipment['shipping_cost'] / $shipment['ex_rate']),2);?></td>
...
?>
 <td align="center">$<?php echo number_format($shipment['total']*(-1),2);?></td>
<td align="center">$0.00</td>
...
?>
<td align="center">$0.00</td>
 <td align="center">$<?php echo number_format($shipment['total'],2);?></td>
