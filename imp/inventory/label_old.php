...
if(isset($_POST['type']) && $_POST['type']=='ajax')
{
	...
	{
		$processedOrders = $inventory->getPackedOrders();
...
// echo $body;exit;
		...
		{
			$json =  array('success'=>$response['label_download']['href']);
		}
...
.my-float{
			...
			<div class="container theme-showcase" role="main">
				<div class="row">
					<div class="col-md-12 text-center">
						<h2 class="hidden">Label Mode <a href="#" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-info-sign" style="font-size:16px" data-toggle="tooltip" title="Help Info (F2)"></i></a></h2>
						
						<h4 data-map="order_id">N/A</h4>
						<span style="font-size:21px;font-weight: bold;color:green" id="estimate_rate">$0.00</span>
					</div>
	...
	<a href="#" class="float" id="get_rate">
<i class="glyphicon glyphicon-time my-float"></i>
</a>
<a href="#" class="float" id="create_label" style="bottom:105px;background-color:#F44336">
<i class="glyphicon glyphicon-ok my-float"></i>
</a>
		...
		function loadOrder(order_id)
		{
			...
			success: function(json) {
				...
				for(i = 0; i <  json['items'].length; ++i)
				{
					...
					html+='<div class="row" style="display:flex;height:80px">';
