...
$pageName = 'Shipstation Transactions';
$pageLink = 'shipstation_transactions.php';
		...
		<table  class="xtable"   align="center" style="width:98%;margin-top: 30px;">
			...
			<tbody>
				...
				foreach($rows as $i=> $row)
				{
					...
					<td align="center"><span class="tag <?=($is_missing?'red-bg':'blue-bg');?>"><?=($is_missing?'Missing':'Mapped');?></span> <span class="tag <?=($row['voided']?'red-bg':'green-bg');?>"><?=($row['voided']==1?'Voided':'Non-Voided');?></span></td>
