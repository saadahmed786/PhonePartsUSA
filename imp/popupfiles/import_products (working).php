...
//				}
				...
				if(($raw_cost and $exchange_rate and $shipping_fee) and $_POST['for_cost'])
				{
				...
				if($grade_c and $_POST['for_grade_a'])
				{
				...
				if($gadgetfix and $_POST['for_gadgetfix'])
				{
					...
					if($check)
					{
						$db->db_exec("UPDATE inv_product_scrape_prices SET url = '".$gadgetfix."',date_updated='".date('Y-m-d H:i:s')."' WHERE sku='".$product_sku."' AND scrape_site='gadgetfix' ");	
				...
				if($mengtor and $_POST['for_mengtor'])
				{
					...
					if($check)
					{
						$db->db_exec("UPDATE inv_product_scrape_prices SET url = '".$mengtor."',date_updated='".date('Y-m-d H:i:s')."' WHERE sku='".$product_sku."' AND scrape_site='mengtor' ");	
					...
					if($mobile_defenders and $_POST['for_mobile_defenders'])
				{
					...
					if($check)
					{
						$db->db_exec("UPDATE inv_product_scrape_prices SET url = '".$mobile_defenders."',date_updated='".date('Y-m-d H:i:s')."' WHERE sku='".$product_sku."' AND scrape_site='mobile_defenders' ");	
				...
				if($ebay and $_POST['for_ebay'])
				{
					...
					if($check)
					{
						$db->db_exec("UPDATE inv_product_scrape_prices SET url = '".$ebay."',date_updated='".date('Y-m-d H:i:s')."' WHERE sku='".$product_sku."' AND scrape_site='ebay' ");	
				...
				if($ebay2 and $_POST['for_ebay'])
				{
					...
					if($check)
					{
						$db->db_exec("UPDATE inv_product_scrape_prices SET url = '".$ebay2."',date_updated='".date('Y-m-d H:i:s')."' WHERE sku='".$product_sku."' AND scrape_site='ebay_2' ");	
				...
				if($ebay3 and $_POST['for_ebay'])
				{
					...
					if($check)
					{
						$db->db_exec("UPDATE inv_product_scrape_prices SET url = '".$ebay3."',date_updated='".date('Y-m-d H:i:s')."' WHERE sku='".$product_sku."' AND scrape_site='ebay_3' ");	
				...
				if($ebay4 and $_POST['for_ebay'])
				{
					...
					if($check)
					{
						$db->db_exec("UPDATE inv_product_scrape_prices SET url = '".$ebay4."',date_updated='".date('Y-m-d H:i:s')."' WHERE sku='".$product_sku."' AND scrape_site='ebay_4' ");	
