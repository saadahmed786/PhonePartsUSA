			...
			<table width="90%" cellspacing="0" cellpadding="5px" border="1" align="center" style="border-collapse:collapse;">
				...
				//}
					...
					<tr class="row_<?php echo $product['product_id'];?>">
						...
						<td align="center">
							<a href="product/<?php echo $product['model'];?>"><?php echo $product['model'];?> (<a class="fancybox3 fancybox.iframe"  href="<?php echo $host_path;?>popupfiles/item_sale_history.php?product=1&sku=<?=$product['model'];?>">Sale History</a>)</a>
						...
						<td align="center" <?php if($product['quantity'] <= $rop):?> style="color:red;" <?php endif;?>>
							<?php if($product['quantity'] <= $rop):?>
								<?php 
								//echo $qty;
								echo ($shipment_data[0]? $shipment_data[0] : '') . '<span><strong>' . $shipment_data[1] . '</strong></span>'; ?>
						...
						<td>
							<input type="number" style="width: 60px; height: 30px;" min="1" value="<?=(int)$shipment_data[1];?>" onchange="updateListQty( this , <?php echo $product['product_id'];?>)" />
						</td>
