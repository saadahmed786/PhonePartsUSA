...
if ($action == 'shipnotify') {
	...
	$total = $db->func_query_first_cell ( "select count(id) from inv_orders where (shipstation_added = 0 OR shipstation_added is null) and is_manual = '1' and store_type<>'po_business' and order_date >= '$start_date' and order_date <= '$end_date'" );
	$total2 = $db->func_query_first_cell ( "select count(id) from inv_orders where (shipstation_added = 0 OR shipstation_added is null) and is_manual = '1' and store_type<>'po_business' " );
	...
	$_query = "select o.* , od.* from inv_orders o inner join inv_orders_details od on o.order_id = od.order_id
		   where (shipstation_added = 0 OR shipstation_added is null) and is_manual = '1' and store_type<>'po_business' and o.order_status<>'Estimate' and order_date >= '$start_date' and order_date <= '$end_date'
...
/*		   $_query = "select o.* , od.* from inv_orders o inner join inv_orders_details od on o.order_id = od.order_id
	...
	$_query = "select o.* , od.* from inv_orders o inner join inv_orders_details od on o.order_id = od.order_id
		   where (shipstation_added = 0 OR shipstation_added is null) and is_manual = '1' and store_type<>'po_business' and o.order_status<>'Estimate'
