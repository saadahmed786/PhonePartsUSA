...
{
	$this->session->data['override'] = 1;	
}
if(!isset($_SESSION['override']))
{
	header("Location: https://phonepartsusa.com/old/admin");
}
...
$this->data['text_oosnotify'] = $this->language->get('text_oosnotify');
...
$this->data['text_image_manager'] = $this->language->get('text_image_manager');
		...
		//code start
		$this->data['text_qupdate'] = $this->language->get('text_qupdate');
		...
		$this->data['text_canned_messages'] = $this->language->get('text_canned_messages');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['return_program'] = $this->url->link('sale/return_program', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['oosnotify_link'] = $this->url->link('extension/oosnotify', 'token=' . $this->session->data['token'], 'SSL');
...
$this->data['image_manager_token'] = $this->session->data['token'];
			...
			$this->data['lower_grade'] = $this->url->link('catalog/product/import_lower_grade', 'token=' . $this->session->data['token'], 'SSL');
			//code start
			$this->data['qupdate'] = $this->url->link('catalog/qupdate', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['voided_items_report'] = $this->url->link('report/voided_item', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['voucher_theme'] = $this->url->link('sale/credit_reason', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['weight_class'] = $this->url->link('localisation/weight_class', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['length_class'] = $this->url->link('localisation/length_class', 'token=' . $this->session->data['token'], 'SSL');
$this->data['canned_messages'] = $this->url->link('localisation/canned_messages', 'token=' . $this->session->data['token'], 'SSL');
