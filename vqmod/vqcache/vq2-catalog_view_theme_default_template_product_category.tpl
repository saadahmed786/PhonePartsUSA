...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-list">
    ...
    <div>
	  ...
	  <a href="<?php echo $product['href']; ?>" style="text-decoration:none">
	  ...
	  <!-- code end -->
	  <img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a><!-- code start --></div><!-- code end --></div>
      <?php } ?>
      ...
      <div class="wishlist">
			...
			<?php echo $button_wishlist; ?></a></div>
      <div class="compare">
