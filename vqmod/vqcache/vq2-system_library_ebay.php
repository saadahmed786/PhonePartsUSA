...
final class Ebay
{
        ...
        if($myDirectory = opendir(DIR_SYSTEM."ebay_addon/")){
            while (false !== ($file = readdir($myDirectory))) {
                if ($file != "." && $file != ".." && $file != ".svn") {
                    include(\VQMod::modCheck(DIR_SYSTEM."ebay_addon/".$file));
     ...
     */
        ...
        if(file_exists(DIR_SYSTEM."ebay_addon/".$addon.".php")){
            include_once(\VQMod::modCheck(DIR_SYSTEM."ebay_addon/".$addon.".php"));
        ...
        if ($this->lasterror === false) {
            ...
            if (isset($response['returns'])) {
                ...
                if ($qry->num_rows > 0) {
                    ...
                    $this->log('Updated returns into ebay_setting_option table');
                } else {
                    ...
                    $this->log('Inserted returns into ebay_setting_option table');
                }
            } else {
