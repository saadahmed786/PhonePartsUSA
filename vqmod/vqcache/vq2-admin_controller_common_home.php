...
'shipping_code' => $result['shipping_code'],
				...
				'ref_order_id'=>$result['ref_order_id'],
				'customer'   => $result['customer'],
				'status'     => $result['status'],
				'date_added' => date($this->language->get('date_format_short_with_time'), strtotime($result['date_added'])),
		...
		{
			$this->data['dashboard_authorized'] = true;	
			
		}
		else
		{
			$this->data['dashboard_authorized'] = false;	
		}
