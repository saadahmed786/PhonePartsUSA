<?php
$_['text_your_address_billing']      = 'Credit Card Billing Address';
// Heading 
...
$_['text_register_account']          = 'Create an account to shop faster, check order statuses and keep track of all previous orders.';
$_['text_forgotten']                 = 'Forgotten Password';
$_['text_your_details']              = 'Your Personal Details';
$_['text_your_address']              = 'Your Address';
$_['text_your_password']             = 'Your Password';
$_['text_agree']                     = 'I have read and agree to the <a class="colorbox" href="%s" target="_blank" style="vertical-align:top" alt="%s"><b style="vertical-align:top">%s</b></a>';
...
$_['entry_address_2']                = 'Suite / Appartment:';
...
*/
$_['error_firstname']                = '*** Invalid***';
$_['error_lastname']                 = '*** Invalid***';
$_['error_email']                    = '*** Required***';
$_['error_telephone']                = '*** Required***';
$_['error_password']                 = '*** Required***';
$_['error_confirm']                  = '*** Required***';
$_['error_company_id']               = '*** Required***';
$_['error_tax_id']                   = '*** Required***';
$_['error_vat']                      = '*** Required***';
$_['error_address_1']                = '*** Invalid***';
$_['error_city']                     = '*** Required***';
$_['error_postcode']                 = '*** Required***';
$_['error_country']                  = '*** Required***';
$_['error_zone']                     = '*** Required***';
