...
class ModelAccountCustomerGroup extends Model {
	...
	public function getCustomerGroupByAccountCode($account_code) {
		
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "customer_group WHERE account_code = '" . $this->db->escape($account_code) . "'");
