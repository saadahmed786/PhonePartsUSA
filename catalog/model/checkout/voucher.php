...
class ModelCheckoutVoucher extends Model {
	...
	public function getVoucher($code) {
		...
		if ($voucher_query->num_rows) {
			...
			$order_query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "order` WHERE order_id = '" . (int)$voucher_query->row['order_id'] . "' AND order_status_id IN('22','3','7','11')");
