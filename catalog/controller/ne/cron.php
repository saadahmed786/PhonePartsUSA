...
class ControllerNeCron extends Controller {
	...
	private function template($schedule) {
		...
		if ($template) {
			...
			if (!$template['uri'] || (!file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/') && !file_exists(DIR_TEMPLATE . 'default/template/ne/templates/' . $template['uri'] . '/'))) {
			...
			if (isset($schedule['defined']) && $schedule['defined'] && (!isset($schedule['recurrent']) || (isset($schedule['recurrent']) && !$schedule['recurrent'])))
			{
				...
				if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/defined.tpl')) {
					$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/defined.tpl';
				} else {
			...
			if (isset($schedule['defined_categories']) && $schedule['defined_categories'])
			{
				...
				foreach ($schedule['defined_categories'] as $category_id) {
					...
					if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/categories.tpl')) {
						$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/categories.tpl';
					} else {
			...
			if (isset($schedule['special']) && $schedule['special'])
			{
				...
				if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/special.tpl')) {
					$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/special.tpl';
				} else {
			...
			if (isset($schedule['latest']) && $schedule['latest'])
			{
				...
				if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/latest.tpl')) {
					$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/latest.tpl';
				} else {
			...
			if (isset($schedule['popular']) && $schedule['popular'])
			{
				...
				if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/popular.tpl')) {
					$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/ne/templates/' . $template['uri'] . '/popular.tpl';
				} else {
