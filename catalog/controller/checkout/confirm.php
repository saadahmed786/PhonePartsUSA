...
class ControllerCheckoutConfirm extends Controller { 
	public function index() {
			...
			if($this->session->data['newcheckout']['address_1'])
		{
			...
			$data['payment_zone'] = $this->model_localisation_zone->getZone($this->session->data['newcheckout']['zone_id'])['name'];
		...
		$data['payment_country'] = $payment_address['country'];
			...
			if (isset($this->session->data['newcheckout']['payment_method'])) {
				$data['payment_method'] = $this->session->data['newcheckout']['payment_method'];
			} else {
				$data['payment_method'] = '';
			}
		...
		if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/checkout/confirm.tpl')) {
			$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/checkout/confirm.tpl';
		} else {
