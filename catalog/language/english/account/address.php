...
$_['error_firstname']   = 'First Name must be between 1 and 32 characters or special character(s) used!';
$_['error_lastname']    = 'Last Name must be between 1 and 32 characters or special character(s) used!';
$_['error_vat']         = 'VAT number is invalid!';
$_['error_address_1']   = 'Address must be between 3 and 128 characters & only use (,`\'.) no other special character!';
//$_['error_address_1']   = 'Password must be between 3 and 128 characters!';
