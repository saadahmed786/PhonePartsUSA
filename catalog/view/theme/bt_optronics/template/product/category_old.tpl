...
<div id="content">
  ...
  <h2><?php //echo $text_refine; ?></h2>
    ...
    <ul class="refine_categories">
      <?php foreach ($categories as $category) { ?>
      <li><a href="<?php echo $category['href']; ?>"><img src="<?php echo $category['thumb']; ?>" /><br/><span><?php echo $category['name']; ?></span></a></li>
      <?php } ?>
    </ul>
    <?php } else { ?>
    ...
    <ul class="refine_categories">
      ...
      <li><a href="<?php echo $categories[$i]['href']; ?>"><img src="<?php echo $categories[$i]['thumb']; ?>" /><br/><span><?php echo $categories[$i]['name']; ?></span></a></li>
      <?php } ?>
      <?php } ?>
    </ul>
    <?php } ?>
