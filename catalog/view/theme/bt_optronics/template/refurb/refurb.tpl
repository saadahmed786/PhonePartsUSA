...
<div class="damage_lcd_container">
	<h2 class="ui dividing header">LCD Refurbishment Program</h2>
		...
		<form method="post" action="<?=$this->url->link('account/login','','SSL');?>">
			...
			<div class="ui two column middle aligned very relaxed stackable grid" style="width:100%">
					...
					<div class="ui form">
						<div class="field" style="margin-bottom:10px">
							...
							<div class="ui left input">
								...
								<input type="hidden" name="redirect" value="<?=$this->url->link('refurb/refurb','','SSL');?>">
							</div>
						</div>
						<div class="field" style="margin-bottom:10px">
				...
				<div class="left aligned column" style="margin-top:-15%">
					...
					<div class="item" style="font-size:12px;font-weight:bold">&#8226; Records Refurbishment Information in Account</div>
				...
				<div class="field" style="width:100%;text-align:center">
					<h2>Submit Refurbishment Form as a Guest</h2>
				</div>
