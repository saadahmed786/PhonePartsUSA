...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="order-list">
    ...
    <div class="order-status"><b><?php echo $text_status; ?></b> <?php echo $order['status']; ?><?php if ($order['tracking_id']) { ?> <br> <b><?php echo $order['tracking_service'] ;?>:  <?php echo $order['tracking_id']; ?> </b> <?php } ?></div>
