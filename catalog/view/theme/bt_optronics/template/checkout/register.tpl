...
<div style="clear: both; padding-top: 6px; font-weight:400; margin-bottom:0px">
...
<div class="buttons">
  <div class="left">
    ...
    <span class="button_pink"><input type="button" value="<?php echo $button_continue; ?>" id="button-register" class="button" /></span>
  </div>
</div>
<?php } else { ?>
<div class="buttons">
