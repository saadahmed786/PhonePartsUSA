        ...
        <tbody>
          ...
          <?php } ?>
            ...
            <td class="quantity"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
              &nbsp;
              <input type="image" src="catalog/view/theme/bt_optronics/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
              <?php if (!$product['stock'] && isset($error_oos)) { ?><span class="stock"><?php echo $error_oos; ?></span><?php } ?></td>
          ...
          <tr>
            <td class="image"></td>
            <td class="name"><span><?php echo $vouchers['description']; ?></span>
				<div class="remove"><a href="<?php echo $vouchers['remove']; ?>"><?php echo $button_remove; ?></a></div>
			</td>	
            <td class="model"></td>
