...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="content">
    ...
    <div class="left">
      ...
      <?php } ?>
	  <div class="buttons">
	    <div class="left"><a href="<?php echo str_replace('&', '&amp;', $back); ?>" class="button"><span><?php echo $button_back; ?></span></a></div>
	    <div class="right"><a onclick="checkRegSubmit();" class="button"><span><?php echo $button_continue; ?></span></a></div>
	  </div>
