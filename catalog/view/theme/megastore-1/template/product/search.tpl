...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="box-heading"><h2 class="search-heading"><?php echo $text_search; ?></h2></div>
  <?php if ($products) { ?>
  ...
  <ul class="product-list">
    ...
    <li>
      ...
      <div class="rating"><img src="catalog/view/theme/megastore/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" /></div>
      <?php } ?>
      <div class="cart">
