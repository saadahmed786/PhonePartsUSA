  ...
  <table style="border-collapse: collapse; width: 100%; border-top: <?php echo $auto_border;?> solid #DDDDDD; border-left: <?php echo $auto_border;?> solid #DDDDDD; margin-bottom: <?php echo $auto_margin;?>;">
    <thead>
      <tr>
        ...
        <td style="font-size: <?php echo $auto_cfont;?>; border-right: <?php echo $auto_border;?> solid #DDDDDD; border-bottom: <?php echo $auto_border;?> solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: right; padding: <?php echo $auto_pad;?>; color: #222222;display:none"><?php echo $text_price; ?></td>
        <td style="display:none;font-size: <?php echo $auto_cfont;?>; border-right: <?php echo $auto_border;?> solid #DDDDDD; border-bottom: <?php echo $auto_border;?> solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: right; padding: <?php echo $auto_pad;?>; color: #222222;"><?php echo $text_total; ?></td>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td style="display:none;font-size: <?php echo $auto_cfont;?>;	border-right: <?php echo $auto_border;?> solid #DDDDDD; border-bottom: <?php echo $auto_border;?> solid #DDDDDD; text-align: right; padding: <?php echo $auto_pad;?>;"><?php echo $product['price']; ?></td>
        <td style="display:none;font-size: <?php echo $auto_cfont;?>;	border-right: <?php echo $auto_border;?> solid #DDDDDD; border-bottom: <?php echo $auto_border;?> solid #DDDDDD; text-align: right; padding: <?php echo $auto_pad;?>;"><?php echo $product['total']; ?></td>
      </tr>
      <?php } ?>
    ...
    <tfoot>
      ...
      <tr style="display:none">
        <td style="font-size: <?php echo $auto_cfont;?>;	border-right: <?php echo $auto_border;?> solid #DDDDDD; border-bottom: <?php echo $auto_border;?> solid #DDDDDD; text-align: right; padding: <?php echo $auto_pad;?>;" colspan="3"><b><?php echo $total['title']; ?>:</b></td>
