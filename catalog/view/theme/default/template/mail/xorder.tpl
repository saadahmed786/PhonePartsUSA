<?php
require_once('/home/phonerep/public_html/imp/inc/barcode/BarcodeGenerator.php');
  require_once('/home/phonerep/public_html/imp/inc/barcode/BarcodeGeneratorPNG.php');
...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <!-- <img alt="testing" src="barcode.php?text=<?php echo $order_id; ?>&size=80" /> --><br>
        <!-- <img alt="testing" src="../barcode.php?text=S<?php echo $order_id; ?>&size=80" /><br> -->
        <img style="width:120px;height:80px" src="data:image/png;base64,<?php echo base64_encode($generator->getBarcode($order_id, $generator::TYPE_CODE_128)); ?>">
