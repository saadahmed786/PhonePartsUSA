...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	...
	public function __construct($config) {
		$this->lib=$config['dir_lib'].$this->lib;
		$this->cache_dir=$config['dir_cache'].$this->cache_dir;
		...
		//global $config;
		$this->consumer_key=$config['ckey'];
		$this->consumer_secret=$config['csecret'];
		$this->user_token=$config['atoken'];
		$this->user_secret=$config['asecret'];
	...
	private function getTwitterJSON() {
		...
		$_POST+=array('request'=>array('host'=>'','url'=>'','parameters'=>''));
