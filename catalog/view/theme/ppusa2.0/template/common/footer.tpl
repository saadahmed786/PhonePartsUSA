...
<footer id="footer">
    <div class="container">
        ...
        <nav class="ftr-menu">
            <ul class="clearfix" style="margin-left: 10%">
                ...
                <li><a href="<?php echo HTTPS_SERVER;?>/index.php?route=information/information&information_id=3">Returns
                        &amp; Warranty</a></li>
                <li><a href="<?php echo HTTPS_SERVER;?>/index.php?route=information/information&information_id=6">Shipping
                        Rates</a></li>
                <li><a href="<?php echo HTTPS_SERVER;?>/index.php?route=information/sitemap">sitemap</a></li>
                <!-- <li><a href="#">rewards program</a></li> -->
                <li><a href="<?php echo HTTPS_SERVER;?>/index.php?route=information/information&information_id=5">Terms
                        &amp; Conditions</a></li>
        ...
        <div class="row ftr-connet">
            <div class="col-md-4 never-miss">
                ...
                <div class="subscribe">
                    <form id="footer-newsletter-form" accept-charset="utf-8"
                          action="<?php echo HTTPS_SERVER.'subscribe_mailchimp.php';?>" method="post" target="_blank">
                        <input type="email" name="email" class="input wf-input wf-req wf-valid__email"
                               placeholder="E-mail...">
                        <button class="btn btn-info light" type="submit">Subscribe <i class="fa fa-angle-right"></i>
                        </button>
            ...
            <div class="col-md-4 follow-us text-center">
                ...
                <p><img src="catalog/view/theme/ppusa2.0/images/footer-icons/shipping.png" alt="Logistics Partners"
                        title="Logistics Partners" style="width:300px"/></p>
            ...
            <div class="col-md-4 follow-us text-center">
                ...
                <p>
                    <img src="catalog/view/theme/ppusa2.0/images/footer-icons/payment.png" style="width:100%"
                         alt="Payment Partners" title="Payment Partners"/>
                </p>
        ...
        <div class="copyrights">
            <p>Copyright &copy; <?php echo date('Y');?> PhonePartsUSA. All Rights Reserved. PhonePartsUSA.com,LLC and
                its products are in no way endorsed, sponsored or affiliated with Apple, Google, HTC, Motorola,
                Blackberry(RIM), LG, Huawei, ZTE, Sony and Samsung or their subsidiaries.</p>
        </div>
        ...
        <script type="text/javascript">
            ...
            <
                ? php
            if (utf8_strlen($this - > config - > get('config_google_shopping_account_id')) > 0) {
                    ?
            >
