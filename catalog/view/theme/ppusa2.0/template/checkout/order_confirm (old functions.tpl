...
<div id="confmOdr" class="tab-pane fade in active">
				...
				<div class="product-detail-inner clearfix">
					...
					<div class="col-md-4 product-detail-img" style="width:167px;">
						<div class="image"><?php if ($item['image']) { ?>
							<a href="javascript:void(0);"><img src="<?php echo $item['image']; ?>" alt="<?php echo $item['image']; ?>" title="<?php echo $item['name']; ?>" /></a>
							<?php } ?>
						</div>
					</div>
					<div class="col-md-8 product-detail-text" style="width: calc(100% - 167px)">

						<h2 style="font-size:15px;margin-bottom:2px"><a href="javascript:void(0);"><?php echo $item['name']; ?></a></h2>
						<div class="row">
							<div class="col-md-7">
							...
							<div class="col-md-5 cart-total-wrp" style="padding-top:0px">
								...
								<div class="cart-total">
									<div class="qtyt-box col-xs-8" style="max-width:100%;margin-left:25px;display:none">
										<div class="input-group spinner">
											<span class="txt" style="font-size: 12px;">QTY</span>
									...
									<h2 class="cartPPrice text-center col-xs-12 text-center" ><?php echo $item['total']; ?><br><small>(<?php echo $item['price']; ?> ea)</small></h2></h4>
								</div>
							</div>
						</div>
		...
		return !isNaN(parseFloat(n)) && isFinite(n);
					    	...
					    	$(document).on('click','#button-place-order',function(){
$.ajax({
		type: 'POST',
