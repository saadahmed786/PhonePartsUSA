...
.return-btn{ width:341px; display:inline-block; color:#fff !important; text-align:center; padding:15px 0; background:#4986fe; border-radius:4px;font-size:16px;}
.return-btn:hover{ text-decoration:none; color:#fff; background:#23527c;}

.return-btn-small{ width:130px; display:inline-block; color:#fff !important; text-align:center; padding:6px 0; background:#4986fe; border-radius:4px;font-size:12px;}
.return-btn-small:hover{ text-decoration:none; color:#fff; background:#23527c;}


/* @ select item
********************************************************************************************
********************************************************************************************/
.selet-item-holder{ width:733px; float:left; background:#4986fe; padding:45px 13px 60px 13px;}
...
<div class="white-box overflow-hide hidden-md hidden-lg">
<div class="row">
<div class="col-xs-12">
<h3 class="blue-title">Access our EZ-Returns page via a desktop computer - Thank you</h3>
</div>
</div>
</div>
  <section class="wrapperx hidden-xs"> 
...
or Zipcode to proceed to the next step.</p>
            ...
            <div align="center" class="content-inner">
            
            	<form align="center">
                     <input style="margin-left: 100px;" align="center" type="text" class="form-control" name="order_id" value="<?php echo $return_order_id;?>"  placeholder="Order ID">
                     <input style="margin-left: 100px;" type="text" class="form-control" name="email" value="<?php echo $return_email;?>"  placeholder="Enter email">
            	</form>
                <span class="or-sapret"><strong class="or">OR</strong></span>
                <form align="center">
                     <input style="margin-left: 100px;" type="text" class="form-control" name="order_id2"  placeholder="Order ID">
                     <input style="margin-left: 100px;" type="text" class="form-control" name="postcode"  placeholder="Zip Code">
            	</form>
...
$(document).ready(function() {
	...
	<?php if($return_order_id)
	{ // start return if the customer has requested return from the order info page
		?>
BeginReturn();
		<?php
	}
