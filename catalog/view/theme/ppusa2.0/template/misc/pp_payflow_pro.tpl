...
<div class="text-center">
					    		<button class="btn btn-primary login-paypal"><img src="catalog/view/theme/ppusa2.0/images/cc-form.png" style="width:100%;cursor:default" alt=""></button>
					    	</div>
	</div>
	<?php
	}
	?>
	<div class="col-md-7 credit-payment sidebox <?php echo ($is_debug?'hidden':'');?>">
