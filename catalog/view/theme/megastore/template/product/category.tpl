...
<div id="content" class="set-size">
  ...
  <div class="category-list">
    ...
    <ul<?php if($this->config->get('refine_search_style') == '1' && $this->config->get('general_status') == '1') { echo ' class="no-image"'; } ?>>
		...
		<?php if($category['thumb'] != '') { $image = $this->model_tool_image->resize($category['thumb'], $this->config->get('config_image_thumb_width'), $this->config->get('config_image_thumb_height')); } else { $image = 'catalog/view/theme/megastore/images/no-image.png'; } ?>
