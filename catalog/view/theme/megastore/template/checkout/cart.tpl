...
<div id="content" class="set-size">
  ...
  <div class="cart-module">
    ...
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      ...
      <table>
        <tr>
          <td style="padding:0px"><span class="required">*</span> <?php echo $entry_country; ?>&nbsp;&nbsp;&nbsp;&nbsp; </td>
          <td style="padding:0px"><select name="country_id">
        ...
        <tr>
          <td style="padding:0px"><span class="required">*</span> <?php echo $entry_zone; ?>&nbsp;&nbsp;&nbsp;&nbsp; </td>
          <td style="padding:0px"><select name="zone_id">
            </select></td>
        </tr>
        <tr>
          <td style="padding:0px"><span id="postcode-required" class="required">*</span> <?php echo $entry_postcode; ?></td>
          <td style="padding:0px"><input type="text" name="postcode" value="<?php echo $postcode; ?>" /></td>
        </tr>
      </table>
