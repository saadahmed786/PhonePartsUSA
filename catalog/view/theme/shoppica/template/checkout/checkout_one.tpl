  ...
  <div>
    ...
    <div style="text-align: center; padding: 15px 0 25px 0;"><b style="font-size:15px;"><?php echo $text_or; ?></b></div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="register">
        <div class="left s_1_2" style="width:48%">
	  ...
	  <div class="left s_1_2" style="width:48%"  <?php if (($this->cart->hasProducts() && !$this->cart->hasShipping()) || $this->config->get('uber_checkout_no_ship_address')) { ?>style="display:none;"<?php } ?>>
      ...
      <?php } ?>	  
	  <div class="s_submit clearfix" style="margin-bottom:25px">
