...
<?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" data-ajax="false">
    ...
    <input type="text" name="company" value="<?php echo $company; ?>" />
            ...
            <div style="display: <?php echo ($company_id_display ? 'block' : 'none'); ?>;">
        ...
        <div style="display: <?php echo ($tax_id_display ? 'block' : 'none'); ?>;">
    ...
    <select name="country_id" onchange="refresh_zone();" data-native-menu="true">
