		   ...
		   <img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" />
		      <?php } ?></a>
					<div class="quantity_new">
						<a href="#" class="mainus_cart"><img src="http://dev2.phonepartsusa.com/catalog/view/theme_mobile/omtex-mobile/image/icon_1.png"></a>
						<input type="text"  name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" id="quantity_new" size="3"/>
						<a href="#" class="plus_cart"><img src="http://dev2.phonepartsusa.com/catalog/view/theme_mobile/omtex-mobile/image/plus_icon.png" id="<?php echo $product['key']; ?>"></a>
					</div><br/>
