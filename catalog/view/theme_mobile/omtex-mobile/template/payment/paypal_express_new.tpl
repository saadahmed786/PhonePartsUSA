...
<?php } ?>
<form action="<?php echo $action; ?>" method="post" id="checkout-form1">
...
<div class="buttons">
 <div class="buttons">
  <div class="center" style="width:55%;"><input type="button" id="button-confirm" class="btn4" onclick="confirmSubmit1()" value="Pay & Complete Order"></div>
</div>
<?php } else { ?>
<div class="buttons">
  <div class="center" style="width:55%;"><input type="button" id="button-confirm" class="btn4" onclick="confirmSubmit1()" value="Pay & Complete Order"></div>
