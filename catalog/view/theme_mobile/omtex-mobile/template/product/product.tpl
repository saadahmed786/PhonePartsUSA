...
<div data-role="content" style="text-align:center; margin-top:0px; padding-top:0px;">
<h2 style="margin:5px;font-size: 16px;"><?php echo $heading_title; ?></h2>
<div class="product-info">
<?php if ($thumb || $images) { ?>
<div class="left">
  <?php if ($thumb) { ?>
  <div class="image"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="fancybox" rel="fancybox" data-ajax="false"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" width="200" /></a></div>
  <?php } ?>
  <?php if ($images) { ?>
  ...
  <?php if ($youtubeproduct) { ?>
      <iframe class="youtube-player" type="text/html" style="margin-bottom:5px" width="280" height="157.5" src="https://www.youtube.com/embed/<?php echo $youtubeproduct ; ?>" frameborder="0"></iframe>
      <?php } ?>
...
<?php if ($price) { ?>
<div class="low_price">
<p><?php echo "Low Price"; //$text_price; ?>
  <?php if (!$special) { ?>
  ...
  <?php } ?>
   ...
   data-options='{"mode": "calbox"}' />
      ...
      <?php } ?>
		<div class="quantity">
			<a href="#" class="mainus" onclick="btnminus(1);"><img src="//phonepartsusa.com/catalog/view/theme_mobile/omtex-mobile/image/icon_1.png"></a>
			<input type="text" name="quantity" id="quantity" size="2" value="<?php echo $minimum; ?>" />
			<a href="#" class="plus" onclick="btnplus();"><img src="//phonepartsusa.com/catalog/view/theme_mobile/omtex-mobile/image/plus_icon.png"></a>
		</div>
	<div class="add_cart">
		<?php if ($stock == 'Out Of Stock' || $stock == 'Out of stock') { ?>
			<a href="#" class="outStock">Out of stock</a>
		<?php } else { ?>
	      	<input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" />
			<!--<input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="" data-theme="b" />-->
			<a onclick="addToCart('<?php echo $product['product_id']; ?>');" id="button-cart"><span><?php echo $button_cart; ?></span></a>
			<!--<a href="#" id="button-cart" value="<?php echo $button_cart; ?>">Add to Cart</a>-->
		<?php } ?>
	</div>
...
<div class="description" >
  ...
  <span style="width: 42%;float: left; padding-top: 20px;"><?php echo $text_stock;  ?></span>-->
	<?php if ($stock == 'Out Of Stock' || $stock == 'Out of stock') { ?>

	<?php } else { ?>
	<div class="stock" style="width: 100%;float: left;">
	<ul>
  <?php if (strtolower($product_info['class']['main_category']) == 'replacement parts') { ?>
          ...
          <div class="new">
              ...
              <h5><?php echo $qualities[$product_info['item_grade']]; ?><span class="showinfo" onclick="$('.condition').fadeIn('400');">?</span></h5>
            </div>
          ...
          <br>
          <?php } else { ?>
		<li style="text-align: center; font-size: 24px;"><img src="/catalog/view/theme_mobile/omtex-mobile/image/rightWat.png" width="32">In Stock</li>
    <?php
  }
  ?>

		<li style="text-align: center;"><img src="/catalog/view/theme_mobile/omtex-mobile/image/rightWat.png" width="17">Ships Same Day</li>
		<li style="text-align: center;display:none"><img src="/catalog/view/theme_mobile/omtex-mobile/image/rightWat.png" width="17">Free Shipping on orders above $100</li>
	</ul>
	</div>
	<?php } ?>
...
<?php //echo $stock; ?>
      ...
      <div class="share" style="margin-left:25%; margin-top:10px; float: left;"><!-- AddThis Button BEGIN -->
        <div class="addthis_default_style"><a class="addthis_button_compact" ><?php echo $text_share; ?></a> <a class="addthis_button_email"></a><a class="addthis_button_print"></a> <a class="addthis_button_facebook"></a> <a class="addthis_button_twitter"></a></div>
        <script type="text/javascript" src="//s7.addthis.com/js/250/addthis_widget.js"></script> 
        <!-- AddThis Button END --> 
		</div><br/></br>
      <!--<div data-role="controlgroup" > 
		<a onclick="addToWishList('<?php echo $product_id; ?>');" data-role="button" data-theme="c" data-icon="add" rel="external">
      ...
      <div data-role="collapsible" data-collapsed="true" data-theme="a" data-content-theme="d">
        ...
        <div data-role="fieldcontain">
          ...
          <fieldset>
            ...
            <textarea name="text" name="review" placeholder="<?php echo $entry_review; ?>">
            </textarea>
          </fieldset>
