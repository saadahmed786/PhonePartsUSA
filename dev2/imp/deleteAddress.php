...
if($_GET['customer_id']){
	...
	$db->db_exec("DELETE from oc_address WHERE address_id='".$_GET['customer_id']."'");
	//echo '<script>parent.window.location.reload(true);</script>';
	header("Location: $host_path/customer_profile.php?id=".$_GET['customer_id']."&email=".$_GET['email']);exit;
...
/*if($_POST['saveChanges']){
	...
	//print_r($user);
	//exit;
	$user['country'] =$customer_id['country_id']; //$db->func_query_first_cell("SELECT country_id FROM `oc_country` WHERE name = '". $user['country'] ."'");

$user['providence'] =$customer_id['zone_id']; //$db->func_query_first_cell("SELECT zone_id FROM `oc_zone` WHERE name = '". $user['providence'] ."' AND country_id = '". $user['country'] ."'");
