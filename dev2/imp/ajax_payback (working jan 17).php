...
$check = $db->func_query_first("SELECT * FROM inv_orders WHERE order_id = '" . $_POST['order_id'] . "'");
...
function paypal_refund() {
	...
	if (!$json['error']) {
        ...
        //
          ...
          if($query['payment_code']=='paypal_express_new' or $query['payment_code']=='pp_standard_new' or strtolower($query['store_type']) == strtolower('bigcommerce'))
          {
