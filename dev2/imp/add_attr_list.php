...
$splitPage  = new splitPageResults($db , $_query , $num_rows , "add_attr_list.php",$page);
...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
		<title>Child Attribute Listing</title>
	</head>
	<body>
		<div align="center">
			<div align="center"> 
	         ...
	         <a href="add_attributes.php?mode=new" class="button">Add New</a>
			 	  	 	...
			 	  	 	<tr>
							 ...
							 foreach($attributes as $attrib)
							 {
							  ...
							  ?></td>
				 	  	 	 ...
				 	  	 	 <td><a href="add_attributes.php?id=<?php echo $row['id']; ?>&mode=edit">Edit</a></td>
				 	  	 	 
				 	  	 	 <td><a href="add_attr_list.php?id=<?php echo $row['id']; ?>&action=delete" onclick="if(!confirm('Are you sure, You want to delete this attributes?')){ return false;}">Delete</a></td>
			 	  	   </tr>
			 	  	 <?php endforeach;?>
