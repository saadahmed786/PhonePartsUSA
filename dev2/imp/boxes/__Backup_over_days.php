...
$_query = "select * from inv_return_shipment_boxes where $where and box_type = 'O60DBox' order by date_added desc";
$count_query = "select count(id) as total from inv_return_shipment_boxes where $where and box_type = 'O60DBox'";

$splitPage   = new splitPageResults($db , $_query , 25 , "over_days.php",$page ,  $count_query);
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	 ...
	 <title>Over 60 Days Boxes</title>
  ...
  <body>
		<div align="center"> 
		 ...
		 <h2 align="center">Over 60 Days Boxes</h2>
		...
		<div align="center">
			<a href="<?php echo $host_path;?>boxes/createbox.php?type=O60DBox&return=over_days">Create new Box</a> <br /><br />
					   ...
					   <td style="width:50px;"><?php echo $k+1;?></td>			   		
			   		   ...
			   		   <td>
			   		       <?php if(($rma_return['status'] == 'Issued' && $_SESSION['edit_pending_shipment']) || $_SESSION['login_as'] == 'admin'):?>	
                              		<a href="<?php echo $host_path;?>boxes/boxes_edit.php?box_id=<?php echo $rma_return['id']?>&return=over_days">Edit</a>
                           <?php endif;?>	
                          
                           <?php if($_SESSION['delete_shipment']):?>
                          		|
                          		<a href="<?php echo $host_path;?>boxes/deletebox.php?action=delete&box_id=<?php echo $rma_return['id']?>&return=over_days" onclick="if(!confirm('Are you sure ?')){ return false; }">Delete</a>
                           <?php endif;?>
			   		   </td>
			   		</tr>
			   <?php endforeach;?>
