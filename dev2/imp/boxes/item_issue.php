...
$_query = "select * from inv_return_shipment_boxes where $where and box_type = 'ItemIssueBox' order by date_added desc";
$count_query = "select count(id) as total from inv_return_shipment_boxes where $where and box_type = 'ItemIssueBox'";

$splitPage   = new splitPageResults($db , $_query , 25 , "item_issue.php",$page ,  $count_query);
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
		<div align="center"> 
		 ...
		 <h2 align="center">Item Issue Boxes</h2>
		...
		<div align="center">
			<a href="<?php echo $host_path;?>boxes/createbox.php?type=ItemIssueBox&return=item_issue">Create new Box</a> <br /><br />
					   ...
					   <td style="width:50px;"><?php echo $k+1;?></td>			   		
			   		   ...
			   		   <td>
			   		       <?php if(($rma_return['status'] == 'Issued' && $_SESSION['edit_pending_shipment']) || $_SESSION['login_as'] == 'admin'):?>	
                              		<a href="<?php echo $host_path;?>boxes/boxes_edit.php?box_id=<?php echo $rma_return['id']?>&return=item_issue">Edit</a>
                           <?php endif;?>	
                          
                           <?php if($_SESSION['delete_shipment']):?>
                          		|
                          		<a href="<?php echo $host_path;?>boxes/deletebox.php?action=delete&box_id=<?php echo $rma_return['id']?>&return=item_issue" onclick="if(!confirm('Are you sure ?')){ return false; }">Delete</a>
                           <?php endif;?>
			   		   </td>
			   		</tr>
			   <?php endforeach;?>
