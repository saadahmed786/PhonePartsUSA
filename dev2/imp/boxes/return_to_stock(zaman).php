...
if((int)$_GET['id'] and $_GET['action'] == 'ignore'){
	...
	$_SESSION['message'] = "RTS Box status is ignored";
...
$_query = "select * from inv_return_shipment_boxes where $where and box_type = 'RTSBox' order by date_added desc";
$count_query = "select count(id) as total from inv_return_shipment_boxes where $where and box_type = 'RTSBox'";

$splitPage   = new splitPageResults($db , $_query , 25 , "boxes/return_to_stock.php",$page ,  $count_query);
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	 ...
	 <title>Return to Stock boxes</title>
  ...
  <body>
		...
		<div align="center">
			<a href="<?php echo $host_path;?>boxes/createbox.php?type=RTSBox&return=return_to_stock">Create new Box</a> <br /><br />
