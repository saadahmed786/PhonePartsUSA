...
if($i==2 and ($detail['status']=='Awaiting' and $flag_change_qty==false)) break;		
		
?>
<h1 style="font-size:12px"><?php echo $title;?></h1>
...
{
?>
<td><?=$product['oem_quantity']+$product['non_oem_quantity'];?></td>
<?php
}
else{
	
	if($i==1 and $flag_received_qty)
	{
		
		?>
        <td align="center">
<input type="text" id="total_received_<?php echo $product['buyback_product_id'];?>" value="<?php echo (int)$product['total_received'];?>" name="total_received[<?php echo $product['buyback_product_id'];?>]" style="width:80px"  /></td>
        <?php
...
<tr>
<td><?=$product['description'];?> OEM</td>
<td align="center">
<?php
if($flag_change_qty and $i==2)
{
	?>
    <input type="text" id="oem_received_<?php echo $product['buyback_product_id'];?>" value="<?php echo $oem_qty;?>" name="oem_received[<?php echo $product['buyback_product_id'];?>]" style="width:80px" onblur="updateRejectedQty('<?php echo $product['buyback_product_id'];?>','<?php echo $product['total_received'];?>')" />
...
{
?>
<?=$product['oem_quantity'];?>
<?php
}
else if($i==2 and ($detail['status']=='QC Completed' or $detail['status']=='Completed'))
{
 echo $quantities['oem_received'];	;	
...
<td><?=($i==2?'$'.number_format($product['oem_price'],2):'');?></td>
<td> </td>

<?php
if($i==2)
{
	if($product['total_oem_total']==0.00)
	{
		//$product['total_oem_total']= round($product['oem_quantity'] * $product['oem_price'],2);
	}
?>
<td><input type="text" name="total_oem_total[<?php echo $product['buyback_product_id'];?>]" id="total_oem_total_<?php echo $product['buyback_product_id'];?>" value="<?php echo (float)$product['total_oem_total'];?>" readOnly /> </td>
<?php
}
?>
</tr>
<tr>
<td><?=$product['description'];?> Non-OEM</td>
<td align="center">
<?php
if($flag_change_qty and $i==2)
{
	?>
    <input type="text" id="non_oem_received_<?php echo $product['buyback_product_id'];?>" value="<?php echo $non_oem_qty;?>" name="non_oem_received[<?php echo $product['buyback_product_id'];?>]" style="width:80px" onblur="updateRejectedQty('<?php echo $product['buyback_product_id'];?>','<?php echo $product['total_received'];?>')" />
    
    <input type="hidden" id="non_oem_price_<?php echo $product['buyback_product_id'];?>" value="<?php echo $product['non_oem_price'];?>" value="<?php echo $product['total_oem_total'];?>" />
...
{
?>
<?=$product['non_oem_quantity'];?>
<?php
}
else if($i==2 and ($detail['status']=='QC Completed' or $detail['status']=='Completed'))
{
 echo $quantities['non_oem_received'];	
	
}
?>
</td>
<td><?=($i==2?'$'.number_format($product['non_oem_price'],2):'');?></td>
<td> </td>

<?php
if($i==2)
{
	if($product['total_non_oem_total']==0.00)
	{
		//$product['total_non_oem_total']= round($product['non_oem_quantity'] * $product['non_oem_price'],2);
	}
?>
<td><input type="text" name="total_non_oem_total[<?php echo $product['buyback_product_id'];?>]" id="total_non_oem_total_<?php echo $product['buyback_product_id'];?>" value="<?php echo (float)$product['total_non_oem_total'];?>" readOnly /> </td>
<?php
}
?>
</tr>
...
<td>Rejected</td>
 ...
 {
 ?>
 <input type="text" id="rejected_qty_<?php echo $product['buyback_product_id'];?>" value="<?php echo $rejected_qty;?>" name="rejected_qty[<?php echo $product['buyback_product_id'];?>]" style="width:80px" />
 <?php
 }
 else
 {
...
<td><input type="text" name="total_rejected_total[<?php echo $product['buyback_product_id'];?>]" id="total_rejected_total_<?php echo $product['buyback_product_id'];?>" value="<?php echo $product['total_rejected_total'];?>" /> </td>
