...
$manual_products2 = $db->func_query("SELECT a.*,b.sku,b.description,sum(a.oem_qty) as oem_received,sum(a.non_oem_qty) as non_oem_received FROM inv_buyback_manual_box_items a,inv_buy_back b WHERE a.sku=b.sku and  a.shipment_id='".$shipment_id."' GROUP BY a.id");
