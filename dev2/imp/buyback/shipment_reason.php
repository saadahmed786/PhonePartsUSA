...
$table = 'inv_buyback_shipment_reasons';
$pageName='Shipment Reason';
$pageLink ="shipment_reason.php";
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="javascript:void(0);" onclick="if(confirm('Are you sure want to delete?')) window.location='<?= $pageLink .'?delete='. $row['id']; ?>'">Delete</a>
					</td>
				</tr>
				<?php } ?>
