                        ...
                        <ul class="nav">
                            ...
                            <li>
                                ...
                                <ul class="drop">
                                    ...
                                    <?php if ($_SESSION['complaint_category'] or $_SESSION['login_as'] == 'admin'): ?>
                            ...
                            <li>
                                ...
                                <ul class="drop">
                                    ...
                                    <?php if ($_SESSION['login_as'] == 'admin' or $_SESSION['classify_product']): ?>
                                        <li><a href="<?php echo $host_path ?>devices_new.php">Classify Product</a></li>
                                    <?php endif; ?>

                                    <?php if ($_SESSION['login_as'] == 'admin' or $_SESSION['product_classification']): ?>
                            ...
                            <?php if ($_SESSION['manage_returns']): ?>
                                <li>
                                    ...
                                    <ul class="drop">
                                        ...
                                        <?php if ($_SESSION['issue_types'] or $_SESSION['user_id'] == 0): ?>
                                        ...
                                        <?php if ($_SESSION['returns_po'] or $_SESSION['user_id'] == 0): ?>
                                        ...
                                        <?php if ($_SESSION['email_return_report'] or $_SESSION['user_id'] == 0): ?>
                                            <li><a href="<?php echo $host_path ?>report_return_emails.php">Return Emails Report</a></li>
                                        <?php endif; ?>

                                        <?php if ($_SESSION['item_wise_return_report'] or $_SESSION['user_id'] == 0): ?>
