...
if(isset($_GET['id']) and $_GET['action'] == 'delete'){
	...
	$db->db_exec("UPDATE inv_product_skus SET attribute_group_id='' where id = '".(int)$_GET['id']."'");
...
$_query = "SELECT * FROM inv_product_skus ORDER BY sku";
			 	  ...
			 	  <table border="1" width="900px;" cellpadding="10" cellspacing="0" style="border:1px solid #585858;border-collapse:collapse;">
			 	  	 ...
			 	  	 <?php foreach($rows as $row):?>
			 	  	 	<tr>
				 	  	 	 ...
				 	  	 	 <td><?php echo (int)substr_count($row['attribute_group_id'],","); ?></td>
				 	  	 	 
				 	  	 	
				 	  	 	 
				 	  	 	 <td><a href="attributes.php?id=<?php echo $row['id']; ?>&mode=edit">Edit</a></td>
				 	  	 	 
				 	  	 	 <td><a href="attribute_list.php?id=<?php echo $row['id']; ?>&action=delete" onclick="if(!confirm('Are you sure, You want to delete this attributes?')){ return false;}">Clear Attributes</a></td>
			 	  	   </tr>
			 	  	 <?php endforeach;?>
