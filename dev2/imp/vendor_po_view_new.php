						...
						<tr>
								<td width="33%" style="vertical-align: top;">
										<table cellpadding="5" cellspacing="0" style="border:1px solid #ddd" width="90%">
												...
												<tr>
														<td>Total (USD)</td>
														<td><?php echo '$'.number_format($my_cost/$shipment_data['ex_rate'],2);?></td>
												...
												<tr>
														<td>Balance (USD)</td>
														<td>-</td>
														<td><?php echo '$'. number_format(($shipment_data['shipping_cost']+$shipment_data['unit_price'])/$shipment_data['ex_rate']-($details['amount_paid']-$applied_credits)+$details['amount_refunded'],2);?></td>
												</tr>
