...
function insertOrderinImp($orderArray){
    ...
    foreach($orderArray as $order){
        ...
        if(!$isExist){
            ...
            $db->db_exec("insert into inv_orders_details (order_id,first_name,last_name,phone_number,address1,address2,city,state,country,zip,payment_method,dateofmodification)
                         values ('$orderId' , '$firstname' , '$lastname' , '$phone' , '$add1' , '$add2' ,'$city' , '$state' , '$country' , '$zip' , '$paymentMethod' ,'".date('Y-m-d H:i:s')."')");
