...
<body>
	...
	<div align="center">
        	...
        	<form method="get">
        		...
        		<a href="rj_reasons.php" class="fancyboxX3 fancybox.iframe button">Update RJ Reasons</a>
        		<?php } ?>
        	</form>
        </div>
        		...
        		<tbody>
        			...
        			<tr id="<?php echo $shipment['id'];?>">
        				...
        				<td align="center" class="showorder">
        					...
        					<?php if($shipment['status'] == 'Issued' && $_SESSION['edit_received_shipment'] && !$vtx):?>
        						|
