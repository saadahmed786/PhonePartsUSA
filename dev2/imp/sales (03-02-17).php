			...
			<table width="90%" cellspacing="0" cellpadding="5px" border="1" align="center" style="border-collapse:collapse;">
				...
				//}
					...
					<tr class="row_<?php echo $product['product_id'];?>">
						...
						<td align="center">
							<a href="product/<?php echo $product['model'];?>"><?php echo $product['model'];?> (<a class="fancybox3 fancybox.iframe"  href="<?php echo $host_path;?>popupfiles/item_sale_history.php?product=1&sku=<?=$product['model'];?>">Part Info</a>)</a>
