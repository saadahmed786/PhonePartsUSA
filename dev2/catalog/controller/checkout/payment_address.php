...
class ControllerCheckoutPaymentAddress extends Controller {
	...
	else
	{
		...
		if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/checkout/payment_address.tpl')) {
			$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/checkout/payment_address.tpl';
		} else {
	...
	if(isset($this->session->data['guest']))
	{
	$this->data['xtelephone'] = $this->session->data['guest']['payment']['address_2'];	
	}
	else
	{
	...
	if(isset($this->session->data['guest']))
	{
	$this->data['xpostcode'] =$this->session->data['guest']['payment']['postcode'];	
	}
	else
	{
		$this->data['xpostcode']='';	
