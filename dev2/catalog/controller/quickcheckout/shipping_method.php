...
class ControllerQuickcheckoutShippingMethod extends Controller {
 public function index() {
        ...
        if ($this->customer->isLogged() && isset($this->session->data['shipping_address_id']) && isset($this->request->post['shipping_address']) && $this->request->post['shipping_address'] == 'existing') {
		...
		if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/'.$quickcheckout.'/shipping_method.tpl')) {
          $this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/'.$quickcheckout.'/shipping_method.tpl';
		   } else {
	...
	public function validate() {
        ...
        /* DV Code */
          $this->session->data['shipping_method']['date'] = strip_tags($this->request->post['date']);         
