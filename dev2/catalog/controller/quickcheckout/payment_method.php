...
class ControllerQuickcheckoutPaymentMethod extends Controller {
  	public function index() {
        ...
        if ($this->customer->isLogged() && isset($this->session->data['payment_address_id']) && isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
        ...
        if (isset($this->session->data['payment_method']['comment'])) {
      
			
        $this->data['comment'] = $this->session->data['payment_method']['comment'];
		...
		if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/'.$quickcheckout.'/payment_method.tpl')) {
          $this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/'.$quickcheckout.'/payment_method.tpl';
		     } else {
	...
	public function validate() {
        ...
        $this->session->data['payment_method']['comment'] = strip_tags($this->request->post['comment']);
