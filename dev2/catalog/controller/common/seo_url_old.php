	...
	public function index() {
		...
		if (isset($this->request->get['_route_'])) {
			...
			foreach ($parts as $part) {
				...
				elseif ($part == 'repair-parts' || $part == 'repair-tools' || $part == 'tempered-glass' || $part == 'accessories' ) {
							// echo 'here';exit;
							switch($part)
							{
								case 'repair-parts':
		...
		if ($this->config->get('config_seo_url')) {
			...
			foreach ($data as $key => $value) {
				if (isset($data['route'])) {
					...
					elseif(($catalog_type=='repair-parts' or $catalog_type=='repair-tools' or $catalog_type=='tempered-glass' or $catalog_type=='accessories') && $key!='path' )
					{
						$url .= '/' . $catalog_type;
					}
					//	elseif ($key == 'path') {
