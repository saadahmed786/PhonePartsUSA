...
class ControllerOneCheckoutConfirm extends Controller { 
	...
	public function index() {
		...
		if (!$json) {
			...
			if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/onecheckout/confirm.tpl')) {
				$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/onecheckout/confirm.tpl';
			} else {
	...
	public function createorder(){
		...
		if (!$json) {
			...
			$data['onecheckout_survey_option'] = isset($this->session->data['onecheckout_survey_option']) ? $this->session->data['onecheckout_survey_option']:'';		
			...
			$this->model_onecheckout_checkout->insertSurvey($this->session->data['order_id'], $data['onecheckout_survey_option']);
			...
			if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/onecheckout/confirmorder.tpl')) {
				$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/onecheckout/confirmorder.tpl';
			} else {
	...
	public function savesurver() {
	
		if(isset($this->request->post['onecheckout_surver'])) {
			$this->session->data['onecheckout_survey_option'] = $this->request->post['onecheckout_surver'];
		}
	
	}
	
	public function insertsurver() {
	
		if(isset($this->request->post['onecheckout_surver']) && $this->request->get['order_id']) {
			$this->session->data['onecheckout_survey_option'] = $this->request->post['onecheckout_surver'];
			$this->load->model('onecheckout/checkout');	
			$this->model_onecheckout_checkout->insertSurvey($this->request->get['order_id'], $this->request->post['onecheckout_surver']);
		}
