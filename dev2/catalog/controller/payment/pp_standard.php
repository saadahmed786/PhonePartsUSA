...
class ControllerPaymentPPStandard extends Controller {
	protected function index() {
		...
		if ($order_info) {
			...
			if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/payment/pp_standard.tpl')) {
				$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/payment/pp_standard.tpl';
			} else {
