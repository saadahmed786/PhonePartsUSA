...
class ControllerTotalShipping extends Controller {
	public function index() {
		if ($this->cart->hasShipping() && $this->config->get('shipping_estimator')) {
			...
			if (file_exists(DIR_TEMPLATE . (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/total/shipping.tpl')) {
				$this->template = (($this->session->data['temp_theme'])? $this->session->data['temp_theme'] : $this->config->get('config_template')) . '/template/total/shipping.tpl';
			} else {
