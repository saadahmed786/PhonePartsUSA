...
<div data-role="content">
	...
	<ul data-role="listview" style="margin-top:10px;">
		...
		<li data-role="list-divider"><?php echo $text_my_lbb; ?></li>
		<li><a href="<?php echo $lbb; ?>" rel="external"><?php echo $text_lbb; ?></a></li>

		<li data-role="list-divider"><?php echo $text_my_returns; ?></li>
		<li><a href="<?php echo $returns; ?>" rel="external"><?php echo $text_returns; ?></a></li>
