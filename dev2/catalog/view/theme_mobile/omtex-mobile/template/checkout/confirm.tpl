...
<!--<ul data-role="listview" data-divider-theme="d" style="margin-top:25px;"> -->
      <?php foreach ($products as $product) { ?>
			<div class="checkout">
				<div class="checkout_detail">
				   ...
				   <img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>"  width="62" height="50"/>
					  <?php } ?>
					<!--<img src="img/phone.jpg">-->
					<div class="product_name">
						<p><?php echo $product['name']; ?></p>
						<span><?php echo $product['model']; ?></span>
						<h6>QTY <?php echo $product['quantity']; ?> |  <?php echo $product['price']; ?> each</h6>
					</div>					
				</div>
				<div class="price">
      ...
      <?php } ?>
<!--</ul>-->
<ul data-role="listview" data-divider-theme="d" style="margin-top:25px; clear: both;">      
...
<ul data-role="listview" data-divider-theme="d" style="margin-top:50px; clear: both;">     
      <?php foreach ($totals as $total) { ?>
		<?php if ($total['code'] == 'shipping') { ?>
	      <li data-role="list-divider" style="text-align:right;"><b>Shipping:</b> <?php echo $total['text']; ?></li>
		<?php } else { ?>
