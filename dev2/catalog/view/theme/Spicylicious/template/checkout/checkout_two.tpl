...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/Spicylicious/stylesheet/ucstyle.css" />
<?php } else { ?>
<?php echo $header; ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/Spicylicious/stylesheet/ucstyle.css" />
...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="content inner" style="text-align:left;">
    ...
    <div style="width:42%; float:left;">
	  ...
	  <div class="buttons">
		<div class="left"><?php echo $add_address_button_html; ?></div>
	    <div class="right"><?php echo $update_address_button_html; ?></div>
	  </div>
	  ...
	  <div class="content">
        ...
        <div style="text-align: right;">
          ...
          <br/>
          <span id="span_comment_button">
		  <?php echo $comment_button_html; ?>
		  </span>
    ...
    <div style="width:54%; float:right;">
      ...
      <div class="content">
        <div style="text-align: right;"><?php echo $entry_coupon; ?>&nbsp;
          ...
          <span id="span_coupon_button">
		  <?php echo $coupon_button_html; ?>
		  </span>
      ...
      <div class="content">
        <div style="text-align: right;"><?php echo $entry_voucher; ?>&nbsp;
          ...
          <span id="span_voucher_button">
		  <?php echo $voucher_button_html; ?>
		  </span>
	  ...
	  <div class="buttons" id="agreefake">
		<span class="right">
		<?php echo $agree_button_html; ?>
		</span>
	  </div>
      <?php } ?>
      <!-- Agree -->
