...
#payment_div {padding-top:50px;}
  ...
  <div id="content" class="s_wrap container_12">
    ...
    <div class="s_row_3 clearfix">
      ...
      <div class="s_full clearfix">
        <?php foreach ($shipping_method['quote'] as $quote): ?>
          ...
          <label class="s_radio" style="white-space:normal" for="<?php echo $quote['code']; ?>"><input type="radio" onchange="updateShippingPaymentTotals();" name="shipping_method" value="<?php echo $quote['code']; ?>" id="<?php echo $quote['code']; ?>" checked="checked" /> <?php echo $quote['title']; ?> - <?php echo $quote['text']; ?></label>
          <?php else: ?>
          <label class="s_radio" style="white-space:normal" for="<?php echo $quote['code']; ?>"><input type="radio" onchange="updateShippingPaymentTotals();" name="shipping_method" value="<?php echo $quote['code']; ?>" id="<?php echo $quote['code']; ?>" /> <?php echo $quote['title']; ?> - <?php echo $quote['text']; ?></label>
          <?php endif; ?>
        <?php endforeach; ?>
      </div>
      <?php else: ?>
...
<div class="clear s_sep border_eee"></div>
  ...
  <div class="s_row_3 clearfix">
    ...
    <label class="s_radio" style="white-space:normal" for="<?php echo $payment_method['code']; ?>">
    ...
    <div style="width:54%; float:right;">
      ...
      <div class="s_row_3 clearfix">
        <div style="text-align: left;"><?php echo $entry_coupon; ?>&nbsp;
          <input style="float:none;" type="text" name="coupon" value="<?php echo $coupon; ?>" />&nbsp;
      ...
      <div class="content">
        <div style="text-align: right;"><?php echo $entry_voucher; ?>&nbsp;
          ...
          <span id="span_voucher_button"><a onclick="updateVoucherPaymentTotals();" class="s_button_1 s_main_color_bgr"><span><?php echo $button_voucher; ?></span></a></span>
...
<div class="clear s_sep border_eee"></div>
      ...
      <div class="buttons well" id="agreefake">
		<span class="right"><a onclick="alert('<?php echo $text_must_agree;?>'); return false;" class="s_button_1 s_main_color_bgr"><span><?php echo $button_confirm; ?></span></a></span>
	  </div>
      <?php } ?>
      <!-- Agree -->
    ...
    <div class="clear s_sep border_eee" style="margin-bottom: 30px;"></div>
