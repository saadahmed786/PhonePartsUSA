 ...
 <div class="box">
  ...
  <div class="middle">
        ...
        <div style="padding: 5px;">
          <table>
            <tr style="width: 40%;">
              ...
              <td rowspan="2" style="text-align: right;"><a href="<?php echo $order['href']; ?>" class="button"><span><?php echo $button_view; ?></span></a></td>
            </tr>
            <tr>
    ...
    <div class="buttons">
      <table>
        <tr>
          <td align="right"><a href="<?php echo $continue; ?>" class="button"><span><?php echo $button_continue; ?></span></a></td>
        </tr>
      </table>
   </div>
 </div>
