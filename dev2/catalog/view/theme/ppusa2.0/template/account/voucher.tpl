...
<div id="content"><?php echo $content_top; ?>
  ...
  <form class="gift-vourcher" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <table class="form">
		...
		<tr><td><span class="required">*</span> <?php echo $entry_amount; ?></td></tr>
    ...
    <div class="buttons">
      <div class="left">
        ...
        <span class="button_pink"><input type="submit" value="<?php echo $button_continue; ?>" class="button" /></span>
      </div>
    </div>
  </form>
