...
<div style="width: 100%" id="quality-pop" class="popup">
	...
	<div class="popup-body">
	<p style="font-size: 10px;"><img src="catalog/view/theme/ppusa2.0/images/icons/premium_logo.png" height="42" width="42" alt=""> Premium: OEM LCD, OEM Touchscreen, OEM Flex Cable</p>
	<p style="font-size: 10px;"><img src="catalog/view/theme/ppusa2.0/images/icons/standard_logo.png" height="42" width="42" alt=""> Standard : OEM LCD, Aftermarket Touchscreen, Aftermarket Flex Cable</p>
	<p style="font-size: 10px;"><img src="catalog/view/theme/ppusa2.0/images/icons/economy_logo.png" height="42" width="42" alt=""> Economy Plus: Highest Quality Fully Aftermarket Part</p>
					...
					<div id="product_item_container" class="cart-items col-md-5" >
						<div class="big-image">
							<img id="img_01" data-zoom-image="<?php echo $popup;?>" src="<?php echo $thumb;?>" alt="">
									...
									?>
							<span class="overlay-x" style="top:-20px;width:32%;height:32%"></span>
							<?php
							}
							?>
						</div>
