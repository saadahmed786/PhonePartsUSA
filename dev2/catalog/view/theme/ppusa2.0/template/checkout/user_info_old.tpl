...
<div class="tab-inner pd100">
	...
	<?php if ($logged) { ?>
	<ul class="row inline-info">
		<li class="col-sm-4 col-xs-6">First Name</li>
		<li class="col-sm-4 col-xs-6">
			<input class="input" value="<?php echo $first_name; ?>" readonly="readonly">
		</li>
	</ul>
	<ul class="row inline-info">
		<li class="col-sm-4 col-xs-6">Last name</li>
		<li class="col-sm-4 col-xs-6">
			<input class="input" value="<?php echo $last_name; ?>" readonly="readonly">
		</li>
	</ul>
	<ul class="row inline-info">
		<li class="col-sm-4 col-xs-6">Business Name </li>
		<li class="col-sm-4 col-xs-6">
			<input class="input" value="<?php echo $business_name; ?>" readonly="readonly">
		</li>
	</ul>
	<ul class="row inline-info">
		<li class="col-sm-4 col-xs-6">Phone</li>
		<li class="col-sm-4 col-xs-6">
			<input class="input" value="<?php echo $phone; ?>" readonly="readonly">
		</li>
	</ul>
	<ul class="row inline-info">
		<li class="col-sm-4 col-xs-6">Email</li>
		<li class="col-sm-4 col-xs-6">
			<input class="input" value="<?php echo $email; ?>" readonly="readonly">
		</li>
	</ul>
	<?php } else { ?>
	<div class="row">
					...
					<div class="form-group">
						...
						<div class="col-xs-12">
							...
							<p style="vertical-align:top">
								<input type="checkbox" class="css-checkbox" name="agree" value="1" id="agree" checked="checked" />
