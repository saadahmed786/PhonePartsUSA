	...
	<div class="footer-holder">
    	<div class="customer-service">
            ...
            <ul class="servics-list">
            	<li><a href="/index.php?route=information/contact">Customer Support</a></li>
                <li><a href="/shipping-information">Shipping Rates</a></li>
                <li><a href="/returns-or-exchanges">Returns & Exchanges</a></li>
                <li><a href="/warranty">Warranty</a></li>
                <li><a href="/index.php?route=account/return/insert">Return Items</a></li>
                <li><a href="/wholesale-accounts">Business Accounts</a></li>
               <!-- <li><a href="#">Education Accounts</a></li>
                <li><a href="#">Our Story</a></li>
                <li><a href="#">Why Trust PhonePartsUSA?</a></li>
        ...
        <div class="social-area">
            ...
            <form id="footer-newsletter-form" accept-charset="utf-8" action="https://app.getresponse.com/add_contact_webform.html?u=jgEp"
    method="post">
