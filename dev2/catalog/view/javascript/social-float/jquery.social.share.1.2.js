		...
		return this.each(function(options){
			...
			function dcssb_social(type){
				...
				switch (type) {
					...
					$button = '<div class="dcssb-btn dcssb-facebook"><iframe src="//www.facebook.com/plugins/like.php?href='+url+'&amp;send=false&amp;layout='+btn+'&amp;width=50&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height='+fbheight+'&amp;appId='+$appId+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height:'+fbheight+'px;" allowTransparency="true"></iframe></div>';					
					break;
//	<iframe src="http://www.facebook.com/plugins/like.php?app_id='+$appId+'&amp;href='+encurl+'&amp;send=false&amp;layout='+btn+'&amp;width=50&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height='+fbheight+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:50px; height:'+fbheight+'px;" allowTransparency="true"></iframe>				
					case 'plusone': 
					btn = 'medium';
					var count = 'false';
					if(size == 'vertical'){
