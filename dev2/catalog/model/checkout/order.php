...
public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
  ...
  if ($order_info && !$order_info['order_status_id']) {
    ...
    $this->createPdf(array('html'=>$xhtml),'drawer/',(($this->session->data['shipping_method']['code']=='multiflatrate.multiflatrate_0')?true:false));
...
public function autoprint_confirm($order_id, $comment = '', $notify = false) {
  ...
  public function createPdf ($data = array(), $dir = '',$is_print=false) {
