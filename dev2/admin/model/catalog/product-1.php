...
class ModelCatalogProduct extends Model {
	...
	public function addProduct($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', cost = '" . (float)$data['cost'] . "', promo_top_right = '" . (int)$data['promo_top_right'] . "', promo_top_left = '" . (int)$data['promo_top_left'] . "', promo_bottom_right = '" . (int)$data['promo_bottom_right'] . "', promo_bottom_left = '" . (int)$data['promo_bottom_left'] . "', promo_date_start = '" . $this->db->escape($data['promo_date_start']) . "', promo_date_end = '" . $this->db->escape($data['promo_date_end']) . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . $this->db->escape($data['tax_class_id']) . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW()");
		

		$product_id = $this->db->getLastId();
		
		$this->db->query("UPDATE " . DB_PREFIX . "product SET model = '" . $this->db->escape($data['model']) . "', sku = '" . $this->db->escape($data['sku']) . "', upc = '" . $this->db->escape($data['upc']) . "', location = '" . $this->db->escape($data['location']) . "', quantity = '" . (int)$data['quantity'] . "', minimum = '" . (int)$data['minimum'] . "', subtract = '" . (int)$data['subtract'] . "', mpn = '" . $this->db->escape($data['mpn']) . "', gtin = '" . $this->db->escape($data['gtin']) . "', google_category_gb = '" . $this->db->escape($data['google_category_gb']) . "', google_category_us = '" . $this->db->escape($data['google_category_us']) . "', google_category_au = '" . $this->db->escape($data['google_category_au']) . "', google_category_fr = '" . $this->db->escape($data['google_category_fr']) . "', google_category_de = '" . $this->db->escape($data['google_category_de']) . "', google_category_it = '" . $this->db->escape($data['google_category_it']) . "', google_category_nl = '" . $this->db->escape($data['google_category_nl']) . "', google_category_es = '" . $this->db->escape($data['google_category_es']) . "', gender = '" . $this->db->escape($data['gender']) . "', age_group = '" . $this->db->escape($data['age_group']) . "', colour = '" . $this->db->escape($data['colour']) . "', size = '" . $this->db->escape($data['size']) . "', material = '" . $this->db->escape($data['material']) . "', pattern = '" . $this->db->escape($data['pattern']) . "', gcondition = '" . $this->db->escape($data['gcondition']) . "', brand = '" . $this->db->escape($data['brand']) . "', vmpn = '" . $this->db->escape($data['vmpn']) . "', vgtin = '" . $this->db->escape($data['vgtin']) . "', vprices = '" . $this->db->escape($data['vprices']) . "', ongoogle = '" . $this->db->escape($data['ongoogle']) . "', google_adwords_grouping = '" . $this->db->escape($data['google_adwords_grouping']) . "', google_adwords_labels = '" . $this->db->escape($data['google_adwords_labels']) . "', google_adwords_publish = '" . $this->db->escape($data['google_adwords_publish']) . "', google_adwords_redirect = '" . $this->db->escape($data['google_adwords_redirect']) . "', google_adwords_queryparam = '" . $this->db->escape($data['google_adwords_queryparam']) . "', stock_status_id = '" . (int)$data['stock_status_id'] . "', date_available = '" . $this->db->escape($data['date_available']) . "', manufacturer_id = '" . (int)$data['manufacturer_id'] . "', shipping = '" . (int)$data['shipping'] . "', price = '" . (float)$data['price'] . "', points = '" . (int)$data['points'] . "', weight = '" . (float)$data['weight'] . "', weight_class_id = '" . (int)$data['weight_class_id'] . "', length = '" . (float)$data['length'] . "', width = '" . (float)$data['width'] . "', height = '" . (float)$data['height'] . "', length_class_id = '" . (int)$data['length_class_id'] . "', status = '" . (int)$data['status'] . "', tax_class_id = '" . (int)$data['tax_class_id'] . "', sort_order = '" . (int)$data['sort_order'] . "', date_added = NOW() WHERE product_id = " . (int)$product_id);

		$this->db->query("UPDATE " . DB_PREFIX. "product SET  video = '" . $this->db->escape($data['youtubeproduct'])."' WHERE product_id = " . (int)$product_id );
