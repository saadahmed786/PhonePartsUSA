...
class ControllerTotalSocialDiscount extends Controller {
	...
	public function index() { 
		...
		if (isset($this->request->post['social_discount_type'])) {
      		$this->data['social_discount_type'] = $this->request->post['social_discount_type'];
    	} else {
      		$this->data['social_discount_type'] = $this->config->get('social_discount_type');
    	}
		
	   	if (isset($this->request->post['social_discount_discount'])) {
      		$this->data['social_discount_discount'] = $this->request->post['social_discount_discount'];
    	} else {
      		$this->data['social_discount_discount'] = $this->config->get('social_discount_discount');;
    	}
