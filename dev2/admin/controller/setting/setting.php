...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		//Tabs
			$this->data['tab_gts']                           = $this->language->get('tab_gts');
			
			//Heading
			$this->data['heading_gts_settings']              = $this->language->get('heading_gts_settings');

			//Entry
			$this->data['entry_gts_store_id']           = $this->language->get('entry_gts_store_id');
			$this->data['entry_badge_position']           = $this->language->get('entry_badge_position');
			$this->data['entry_gts_locale']   = $this->language->get('entry_gts_locale');
			$this->data['entry_google_shopping_account_id']         = $this->language->get('entry_google_shopping_account_id');
			$this->data['entry_google_shopping_country'] = $this->language->get('entry_google_shopping_country');
			$this->data['entry_google_shopping_language']            = $this->language->get('entry_google_shopping_language');
			$this->data['entry_domain']                  = $this->language->get('entry_domain');
			$this->data['entry_has_digital_goods']        = $this->language->get('entry_has_digital_goods');
			...
			$this->data['entry_gts_status']           = $this->language->get('entry_gts_status');
			$this->data['text_gts_enabled']           = $this->language->get('text_gts_enabled');
			$this->data['text_gts_disabled']         = $this->language->get('text_gts_disabled');
		...
		if (isset($this->error['error_gts_store_id'])) {
					$this->data['error_gts_store_id'] = $this->error['error_gts_store_id'];
				} else {
					$this->data['error_gts_store_id'] = '';
				}
				
				if (isset($this->error['error_gts_locale'])) {
					$this->data['error_gts_locale'] = $this->error['error_gts_locale'];
				} else {
					$this->data['error_gts_locale'] = '';
				}
				
				if (isset($this->error['error_domain'])) {
					$this->data['error_domain'] = $this->error['error_domain'];
				} else {
					$this->data['error_domain'] = '';
				}
				
				if (isset($this->error['error_google_shopping_country'])) {
					$this->data['error_google_shopping_country'] = $this->error['error_google_shopping_country'];
				} else {
					$this->data['error_google_shopping_country'] = '';
				}
				
				if (isset($this->error['error_google_shopping_language'])) {
					$this->data['error_google_shopping_language'] = $this->error['error_google_shopping_language'];
				} else {
					$this->data['error_google_shopping_language'] = '';
				}
		...
		if (isset($this->request->post['config_gts_status'])) {
					$this->data['config_gts_status'] = $this->request->post['config_gts_status'];
				} else {
					$this->data['config_gts_status'] = $this->config->get('config_gts_status');
				}
				
				if (isset($this->request->post['config_gts_store_id'])) {
					$this->data['config_gts_store_id'] = $this->request->post['config_gts_store_id'];
				} else {
					$this->data['config_gts_store_id'] = $this->config->get('config_gts_store_id');
				}
				
				if (isset($this->request->post['config_badge_position'])) {
					$this->data['config_badge_position'] = $this->request->post['config_badge_position'];
				} else {
					$this->data['config_badge_position'] = $this->config->get('config_badge_position');
				}
				
				if (isset($this->request->post['config_gts_locale'])) {
					$this->data['config_gts_locale'] = $this->request->post['config_gts_locale'];
				} else {
					$this->data['config_gts_locale'] = $this->config->get('config_gts_locale');
				}
				
				if (isset($this->request->post['config_google_shopping_account_id'])) {
					$this->data['config_google_shopping_account_id'] = $this->request->post['config_google_shopping_account_id'];
				} else {
					$this->data['config_google_shopping_account_id'] = $this->config->get('config_google_shopping_account_id');
				}
				
				if (isset($this->request->post['config_google_shopping_country'])) {
					$this->data['config_google_shopping_country'] = $this->request->post['config_google_shopping_country'];
				} else {
					$this->data['config_google_shopping_country'] = $this->config->get('config_google_shopping_country');
				}
				
				if (isset($this->request->post['config_google_shopping_language'])) {
					$this->data['config_google_shopping_language'] = $this->request->post['config_google_shopping_language'];
				} else {
					$this->data['config_google_shopping_language'] = $this->config->get('config_google_shopping_language');
				}
				
				if (isset($this->request->post['config_domain'])) {
					$this->data['config_domain'] = $this->request->post['config_domain'];
				} else {
					$this->data['config_domain'] = $this->config->get('config_domain');
				}
				
				if (isset($this->request->post['config_has_digital_goods'])) {
					$this->data['config_has_digital_goods'] = $this->request->post['config_has_digital_goods'];
				} elseif ($this->config->get('config_has_digital_goods')) {
					$this->data['config_has_digital_goods'] = $this->config->get('config_has_digital_goods');
				} else {
					$this->data['config_has_digital_goods'] = 'N';	
				}
	...
	private function validate() {
		...
		if (!$this->request->post['config_gts_store_id']) {
					$this->error['error_gts_store_id'] = $this->language->get('error_gts_store_id');
				}
				
				if (!$this->request->post['config_gts_locale']) {
					$this->error['error_gts_locale'] = $this->language->get('error_gts_locale');
				}
				
				if (!$this->request->post['config_domain']) {
					$this->error['error_domain'] = $this->language->get('error_domain');
				}
				
				if (utf8_strlen($this->request->post['config_google_shopping_account_id']) > 0) {
					if (!$this->request->post['config_google_shopping_country']) {
						$this->error['error_google_shopping_country'] = $this->language->get('error_google_shopping_country');
					}
					
					if (!$this->request->post['config_google_shopping_language']) {
						$this->error['error_google_shopping_language'] = $this->language->get('error_google_shopping_language');
					}
