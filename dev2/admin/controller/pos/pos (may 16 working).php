...
//        $this->model_sale_order->backUpOrder($this->request->get['order_id']); // taking backup
        ...
        if ($customer_info) {
            $customer_detail = array('customer_id' => $customer_info['customer_id'],'customer_email' => $customer_info['email'], 'customer_name' => $customer_info['firstname'] . ' ' . $customer_info['lastname']);
