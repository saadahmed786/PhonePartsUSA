...
class ControllerSaleManageOrder extends Controller {
	...
	public function addhistory() {
  	...
  	private function getList() {
		...
		$this->data['update_b_order'] = $this->user->updateBOrder();
		...
		foreach ($results as $result) {
			...
			$orders_data[] = array(
				'order_id'      => ($result['ref_order_id']?$result['ref_order_id']:$result['order_id']),
				'invoice_id'    => $result['invoice_id'],
				'admin_view_only'    => $result['admin_view_only'],
				...
				'cash_split'	=>$this->currency->format($result['cash_split'], $result['currency_code'], $result['currency_value']),
				'card_split'	=>$this->currency->format($result['card_split'], $result['currency_code'], $result['currency_value']),
