        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="maximum_amount" value="<?php echo $maximum_amount; ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><div class="scrollbox">
                  ...
                  <?php foreach ($customer_groups as $groups) {  ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div class="<?php echo $class; ?>">
                    <input type="checkbox" name="customer_group[]" value="<?php echo $groups['customer_group_id']; ?>" 
                    <?php
                    
                    foreach($customer_group as $value)
{

    if(in_array($groups['customer_group_id'], $value))
    {
        echo "checked";
    }
}?> />
                    <?php echo $groups['name']; ?> </div>
                  <?php } ?>
                </div></td>
            </tr>
            <tr>
