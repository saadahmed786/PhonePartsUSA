<div class="container-fluid">
	<div class="row">
  		<div class="col-md-4">
			...
			<?php if (empty($data['ProductBundles']['LicensedOn'])): ?>
                	...
                	<tr>
                    	<td colspan="2">
                            <div class="form-group">
                                ...
                                <input type="text" class="licenseCodeBox form-control" placeholder="License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" name="ProductBundles[LicenseCode]" id="moduleLicense" value="<?php echo !empty($data['ProductBundles']['LicenseCode']) ? $data['ProductBundles']['LicenseCode'] : ''?>" />
                            </div>
			...
			<?php if (!empty($data['ProductBundles']['LicensedOn'])): ?>
    			<input name="cHRpbWl6YXRpb24ef4fe" type="hidden" value="<?php echo base64_encode(json_encode($data['ProductBundles']['License'])); ?>" />
    			<input name="OaXRyb1BhY2sgLSBDb21" type="hidden" value="<?php echo $data['ProductBundles']['LicensedOn']; ?>" />
    			<table class="table licensedTable">
                    <tr>
                    	<td>License Holder</td>
                    	<td><?php echo $data['ProductBundles']['License']['customerName']; ?></td>
                    </tr>
                	<tr>
                		<td>Registered domains</td>
                		<td>
                    		<ul class="registeredDomains">
                    			<?php foreach ($data['ProductBundles']['License']['licenseDomainsUsed'] as $domain): ?>
                	...
                	<tr>
                		...
                		<td><?php echo date("F j, Y",strtotime($data['ProductBundles']['License']['licenseExpireDate'])); ?></td>
                	</tr>
                	<tr>
    		...
    		<div class="box-contents">
            	<div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <img alt="Community support" style="width: 300px;" src="view/image/productbundles/community.png">
                        ...
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <img data-src="holder.js/300x200" alt="Ticket support" style="width: 300px;" src="view/image/productbundles/tickets.png">
                                <div class="caption" style="text-align:center;padding-top:0px;">
                                    <h3>Tickets</h3>
                        ...
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <img alt="Pre-sale support" style="width: 300px;" src="view/image/productbundles/pre-sale.png">
                                <div class="caption" style="text-align:center;padding-top:0px;">
                                    <h3>Pre-sale</h3>
