...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-google"><?php echo $tab_google; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a></div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          ...
          <table class="form">
            ...
            <!-- Add youtube -->
          <tr>
            <td><?php echo $entry_youtubeproduct; ?></td>
            <td><input type="text" name="youtubeproduct" value="<?php echo $youtubeproduct; ?>" />
            <?php echo "*** (sample) See URL in top-right then you see black code after v= *** http://www.youtube.com/watch?v=<B>BA7fdSkp8ds</B> enter code is BA7fdSkp8ds"; ?>
            </td>
          </tr>
          <!-- End Add youtube -->
