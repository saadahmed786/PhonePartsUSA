          ...
          <div id="tab-data">
            ...
            <table class="form">
              ...
              <tr>
                ...
                <tr id="main_sku" <?php if($is_main_sku) { ?>style="display:none" <?php } ?>>

                  <td>Main SKU</td>

                  <td><input type="text" name="main_sku" value="<?php echo $main_sku; ?>" /></td>

                </tr>


                <tr id="item_grade" <?php if($is_main_sku) { ?>style="display:none" <?php } ?> >

                  <td>Item Grade</td>

                  <td><select name="item_grade">
                    <option value="">--Please Select--</option>
                    <option value="Grade A" <?php echo ($item_grade=='Grade A'?'selected':'');?>>Grade A</option>
                    <option <?php echo ($item_grade=='Grade B'?'selected':'');?> value="Grade B">Grade B</option>
                    <option <?php echo ($item_grade=='Grade C'?'selected':'');?> value="Grade C">Grade C</option>
                ...
                <tr id="is_kit">
                  ...
                  <td><select name="is_kit">

                    <option value="0" <?php echo ($is_kit=='0'?'selected':'');?>>No</option>
                    <option <?php echo ($is_kit=='1'?'selected':'');?> value="1">Yes</option>
                  ...
                  <div id="tab-links">
                    ...
                    <table class="form">
                      ...
                      <tr>
                        ...
                        <td><div class="scrollbox" style="width:550px;height:400px;float:left" id="category_box_1">
                          ...
                          <div class="<?php echo $class; ?>">
                            ...
                            <input type="checkbox" name="product_category[]" value="<?php echo $category['category_id']; ?>" checked="checked" onChange="AddThis(this)" />

                            <?php echo $category['name']; ?>

                            <?php } else { ?>

                            <input type="checkbox" name="product_category[]" value="<?php echo $category['category_id']; ?>" onChange="AddThis(this,'<?php echo $category['name'];?>')"  />
                        ...
                        <div class="scrollbox" id="category_box_2" style="width:430px;height:400px;float:right">


                        </div>
                        <div style="clear:both">
                          <a onclick="$('#category_box_1').find(':checkbox').attr('checked', true);LoopThrough();"><?php echo $text_select_all; ?></a> <a onclick="LoopThroughOut();" style="margin-left:545px;" ><?php echo $text_unselect_all; ?></a>
                        </div>
     ...
     <script type="text/javascript"><!--
      ...
      <script type="text/javascript"><!--
        function checkYoutubeId (t) {
          $.ajax({
            url: '<?php echo HTTPS_CATALOG; ?>imp/product.php',
            type: 'POST',
            dataType: 'json',
          ...
          .always(function(json) {
            if (json['error']) {
              $(t).parent().find('span').text(json['msg']);
              $(t).val('');
            }
            if (json['success']) {
              $(t).parent().find('span').text(json['msg']);
        ...
        function RemoveThis(Obj)
        {
         ...
         $checkbox.closest('div').show(500).effect('highlight');;
         $(Obj).closest('div').hide(500);
       ...
       $(document).ready(function(e) {
        ...
        $('select[name=is_main_sku]').on('change',function(){
