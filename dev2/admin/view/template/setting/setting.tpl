  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-gtc">
				<h2><?php echo $heading_gts_settings; ?></h2>
				<table class="form">
					<tr>
						<td><span class="required">*</span><?php echo $entry_gts_store_id; ?></td>
						<td><input type="text" name="config_gts_store_id" value="<?php echo $config_gts_store_id; ?>" />
						<?php if ($error_gts_store_id) { ?>
						<span class="error"><?php echo $error_gts_store_id; ?></span>
						<?php } ?></td>
					</tr>
					<tr>
						<td><?php echo $entry_badge_position; ?></td>
						<td>
							<select name="config_badge_position">
									<option value="1" <?php if ($config_badge_position == 1) { echo 'selected="selected"'; } ?>><?php echo $text_bottom_left; ?></option>
									<option value="2" <?php if ($config_badge_position == 2) { echo 'selected="selected"'; } ?>><?php echo $text_bottom_right; ?></option>
							</select>
						</td>
					</tr>
					<tr>
						<td><span class="required">*</span><?php echo $entry_gts_locale; ?></td>
						<td><input type="text" name="config_gts_locale" value="<?php echo $config_gts_locale; ?>" />
						<?php if ($error_gts_locale) { ?>
						<span class="error"><?php echo $error_gts_locale; ?></span>
						<?php } ?></td>
					</tr>
					<tr>
						<td><span class="required">*</span><?php echo $entry_domain; ?></td>
						<td><input type="text" name="config_domain" value="<?php echo $config_domain; ?>" />
						<?php if ($error_domain) { ?>
						<span class="error"><?php echo $error_domain; ?></span>
						<?php } ?></td>
					</tr>
					<tr>
						<td><?php echo $entry_has_digital_goods; ?></td>
						<td><input type="text" name="config_has_digital_goods" value="<?php echo $config_has_digital_goods; ?>" /></td>
					</tr>
					<tr>
						<td><?php echo $entry_google_shopping_account_id; ?></td>
						<td><input type="text" name="config_google_shopping_account_id" value="<?php echo $config_google_shopping_account_id; ?>" /></td>
					</tr>
					<tr>
						<td><?php echo $entry_google_shopping_country; ?></td>
						<td><input type="text" name="config_google_shopping_country" value="<?php echo $config_google_shopping_country; ?>" />
						<?php if ($error_google_shopping_country) { ?>
						<span class="error"><?php echo $error_google_shopping_country; ?></span>
						<?php } ?></td>
					</tr>
					<tr>
						<td><?php echo $entry_google_shopping_language; ?></td>
						<td><input type="text" name="config_google_shopping_language" value="<?php echo $config_google_shopping_language; ?>" />
						<?php if ($error_google_shopping_language) { ?>
						<span class="error"><?php echo $error_google_shopping_language; ?></span>
						<?php } ?></td>
					</tr>
					<tr>
						<td><?php echo $entry_gts_status; ?></td>
						<td><select name="config_gts_status">
						<?php if ($config_gts_status) { ?>
						<option value="1" selected="selected"><?php echo $text_gts_enabled; ?></option>
						<option value="0"><?php echo $text_gts_disabled; ?></option>
						<?php } else { ?>
						<option value="1"><?php echo $text_gts_enabled; ?></option>
						<option value="0" selected="selected"><?php echo $text_gts_disabled; ?></option>
						<?php } ?>
					  </select></td>
					</tr>
				</table>
