...
//Tabs
			$_['tab_gts']                  = 'Google Trusted Store';
			
			//Heading
			$_['heading_gts_settings']  = 'Google Trusted Store Settings';
			
			//Entry
			$_['entry_gts_store_id']            = 'Store ID:<br /><span class="help">Google Trusted Stores ID</span>';
			$_['entry_badge_position']            = 'Badge Position:<br /><span class="help">Position to show badge either Left or Right</span>';
			$_['entry_gts_locale']    = 'Page Language:<span class="help">The locale should be in the format of <language>_<country>. e.g. en_US, en_GB, en_AU, fr_FR, de_DE, or ja_JP.</span>';
			$_['entry_google_shopping_account_id']          = 'Google Shopping Account ID:<br /><span class="help">Provide this field only if you submit feeds for Google Shopping. Account ID from Google Merchant Center.</span>';
			$_['entry_google_shopping_country']  = 'Google Shopping Country:<span class="help">Account country from Google Shopping. The value of the country parameter should be a <a target="_blank" href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">two-letter ISO 3166 country code.</a> For example, values could be "US", "GB", "AU".</span>';
			$_['entry_google_shopping_language']             = 'Google Shopping Language:<br /><span class="help">Account language from Google Shopping. The value of the language parameter should be a <a target="_blank" href="http://en.wikipedia.org/wiki/ISO_639-1">two-letter ISO 639-1 language code.</a> For example, values could be "en", "fr", "de", "ja".</span>';
			$_['entry_gts_status']            = 'Status:';

			$_['entry_domain']           = 'Merchant Order Domain:<br /><span class="help">Domain name associated with the order, formatted as www.mystore.com.</span>';
			$_['entry_has_digital_goods']         = 'Has Digital Goods?:<br /><span class="help">Y if 1 or more items in the order is delivered digitally. Otherwise N.</span>';
			
			// Texts
			$_['text_bottom_left']            = 'Bottom Left';
			$_['text_bottom_right']           = 'Bottom Right';
			$_['text_gts_enabled']            = 'Enabled';
			$_['text_gts_disabled']           = 'Disabled';
			
			// Warnings
			$_['error_gts_store_id']            = 'Google Trusted Stores ID required!';
			$_['error_gts_locale']            = 'Page Language required!';
			$_['error_domain']          = 'Merchant Order Domain required!';
			$_['error_google_shopping_country']          = 'Google Shopping Country required!';
			$_['error_google_shopping_language']          = 'Google Shopping Language required!';
